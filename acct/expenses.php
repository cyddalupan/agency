...
<p style="color:black">" Note: all status <b>NOT</b> <i style="color:red">RELEASED</i> automatic <i style="color:red">DEBIT</i> to <i style="color:red">Supplier</i> "</p>
<p style="color:black">" Note: IF <i style="color:red">RELEASED</i> automatic <i style="color:red">CREDIT</i> to <i style="color:red">Supplier</i> "</p>
...
$set_ = mysql_query("SELECT * FROM set_ WHERE set_type IN('APPLICANT EXPENSE')ORDER BY account asc");
while($setr=mysql_fetch_array($set_))
{
echo'<option value="'.$setr["account"].'">'.$setr["account"].'</option>';
}
