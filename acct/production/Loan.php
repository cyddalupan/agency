...
<th STYLE="width:15%">Requesting Party</th>

<th STYLE="width:15%">CURRENCY</th>
<th STYLE="width:15%">TOTAL LOAN</th>
<th STYLE="width:15%"> LOAN DEDUCTION</th>
<th STYLE="width:15%;color:Red"> LOAN BALANCE</th>
<th>ACTION</th>
</tr>
</thead>
<tbody>
...
echo'<td>'.$cashliq['cashfund'].'</td>';
echo'<td>'.$balanceloan.'</td>';
echo'<td>
<a href="loan-status.php?e_id='.$row["e_id"].'&&amt='.$row["amount"].'&&date_ad='.$row["date_ad"].'&&name='.$rowu["user_fullname"].'&&employe='.$row["staff_id"].'" target="_blank" ">Loan Status</a>
</td>';
