...
$insert=mysql_query("INSERT INTO suppliers_docs (agent_id,docs_fie,docs_name,file_status)
VALUES (".$_GET['agent'].",'".$filename1."','".$_POST['docs_name']."','agent' )");
echo'Added';
...
$app11111 = mysql_query("SELECT * FROM suppliers_docs where agent_id=".$_GET['agent']."
