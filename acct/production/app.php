...
$app = mysql_query("SELECT * FROM email_address2 order  by date_medical desc limit 5");
if(isset($_POST['submitsearch']))
{
$app = mysql_query("SELECT * FROM email_address2 where agent_id='".$_POST['agent_id']."' ");
...
$usertype = mysql_query("SELECT * FROM email_address2  group by agent_id desc");
...
echo'<tr>';
echo'<td  style="width:30px" >';echo' <input type="HIDDEN" name="appnumber[]" value="'.$row["appnumber"].'">'.$row["appnumber"].'</td>';
...
ECHO'</select>
</td>';//echo'<td><input type="text" name="date_applied[]" value="'; echo gmdate("Y-m-d", $UNIX_DATE);echo'"></td>';
