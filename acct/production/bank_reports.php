...
<h2 style="color:blue;font-size:20px"><u>Cash IN <small  style="color:black">(DEBIT)</small></u></h2>
...
$cashin = mysql_query("SELECT * FROM  cash_transaction WHERE cash_bank_in=".$_GET['accounts']."
$cashindate
...
if($collected1["currency"]=="PHP"){$myamt=$collected1["amount"]/50;}
...
$finalcashins=$grandcashin+$totalreceived;
?>
<tr>
