...
<input type="text" placeholder="search branch" class="form-control" name="search1" required>
</div>

<div class="col-md-6 col-sm-12 col-xs-12 form-group">
<button type="submit" class="btn btn-info"  name="SearchME" >Search Branch</button>
...
<select  class="selectpicker" single data-live-search="true"  name="typess" required style="width:200px">
<option></option>

<option VALUE="1">PARANAQUE MAIN OFFICE</option><option VALUE="2">BACOLOD BRANCH</option>
<option VALUE="3">BUTUAN BRANCH</option><option VALUE="4">CEBU BRANCH </option><option VALUE="5">CAGAYAN DE ORO BRANCH </option><option VALUE="6">DAVAO BRANCH </option><option VALUE="7">DIPOLOG BRANCH </option><option VALUE="8">DUMAGUETE BRANCH</option><option VALUE="9">GENSAN BRANCH</option><option VALUE="10">IPIL BRANCH</option><option VALUE="11">MAASIN BRANCH</option><option VALUE="12">OZAMIZ BRANCH </option><option VALUE="13">PAGADIAN BRANCH </option><option VALUE="14">SINDANGAN BRANCH</option><option VALUE="15">TACLOBAN BRANCH</option><option VALUE="16">TAGUM BRANCH</option><option VALUE="17">VALENCIA BRANCH</option><option VALUE="18">ZAMBOANGA BRANCH</option><option VALUE="19"> ROXAS BRANCH</option>
</select>
...
foreach ($_POST['delall1'] as $delall) {
...
where
singil=1
AND applicant_remarks1 LIKE '%".$_POST['search1']."%' ");
...
where  applicant_remarks1='".$row['applicant_remarks1']."'
AND singil=1");
...
echo'<tr style="">';
echo'<td><input type="checkbox" name="delall1[]" value="'.$row['applicant_id'].'" checked></td>';

echo'<td>'.$row["applicant_first"].' '.$row["applicant_middle"].'  '.$row["applicant_last"].'</td>';
echo'<td>'.$row["applicant_remarks1"].'</td>';
