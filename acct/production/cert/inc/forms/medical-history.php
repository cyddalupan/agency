...
$exam_result="";
$list="";
$ifexist=mysql_query("SELECT * FROM patient_result_exam where p_id='".$_GET['p_id']."' and exam_type='medicalhistory'");
...
<input type="submit" name="save-medical-history" value="SAVE" style="float:right" />
<?php } ?>
</form>
</div>
<div style="height:20px; clear:both"></div>
<?php 
include 'physical-exam.php';
?>