...
#medical-history td{padding:2px;padding-left:10px;}
...
PATIENT NAME : <?=$update['lname']?> ,  <?=$update['fname']?>  <?=$update['mname']?> | 
DATE REGISTERD : <?=$update['dateadded']?> </h3><?php */?>
<h4 style="background:#000000; color:#FFFFFF; padding:3px">PHYSICAL EXAMINATION to be completed by the examining physician</h4>
<form method="post" action="?p_id=<?=$_GET['p_id']?>&p=1">
<?php 
$p_id="";
if(isset($_GET['p_id'])){
$p_id=$_GET['p_id'];
