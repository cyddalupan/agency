...
$app = mysql_query("SELECT * FROM email_address4  where emp_id=0 order by exp_id desc ");
...
<a href="edit_unfit.php?exp='.$row["exp_id"].'" target="_blank"  STYLE="COLOR:BLUE">Edit</button></a>
</td>';
echo'</tr>';
}
?>	
