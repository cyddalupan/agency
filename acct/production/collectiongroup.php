...
<h3 class="pull-left">Collection <small>(FRA)</small></h3>
<div class="row">
...
if($row["collect_status"]==1){$request='Received';$rcolor='green';}
if($row["collect_status"]==2){$request='Return to maker';$rcolor='red';}

$mytotal=$row["amount"]+($row["bankcharge"]+$row["deduction"]);
...
echo'<td STYLE="FONT-SIZE:12PX;font-weight:bold">'.$row["currency"].'</td>';
echo'<td STYLE="FONT-SIZE:12PX;font-weight:bold">'.$row["amount"].'</td>';
echo'<td STYLE="FONT-SIZE:12PX;font-weight:bold">'.$row["deduction"].'</td>';
echo'<td STYLE="FONT-SIZE:12PX;font-weight:bold">'.$row["bankcharge"].'</td>';
echo'<td STYLE="FONT-SIZE:16PX;font-weight:bold;color:Red">'.$mytotal.'</td>';
...
<input type="hidden" class="form-control" name="collect_status" value="1" required>
...
<label class="control-label col-md-3 col-sm-3 col-xs-12">Date of Remittance</label>
...
<div class="col-md-9 col-sm-9 col-xs-12">
<input type="number" class="form-control" name="deduction" step="any" required>
</div>
</div>
...
<div class="col-md-9 col-sm-9 col-xs-12">
<input type="number" class="form-control" name="bankcharge" step="any" required>
</div>
</div>
...
<input type="hidden" class="form-control" name="account"  value="remittance">
