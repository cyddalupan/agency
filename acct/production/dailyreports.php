...
where email_address.date_ad between '".$_POST['start']."' AND '".$_POST['start']."'
...
<td colspan="10" style="border:none;text-align:center"> <h2>DAILY EXPENSE </br> <?php echo date('Y-M-d', strtotime($_POST['start'])); ?>  </h2> </td>
</tr>
...
<tr>
<td style="FONT-WEIGHT:bold;text-align:right;font-size:22px;background:lightblue" colspan="12">GRAND TOTAL AMOUNT : &nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
