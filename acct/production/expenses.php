...
<h3>Office Expenses (FIXED RATE)</h3>
...
<div class="col-md-9 col-sm-9 col-xs-12">
<?php echo'
<select class="form-control" name="account" required onchange="showprice(this.value)" >
<option>'.$row["account"].'</option>';
...
<div class="col-md-9 col-sm-9 col-xs-12" required >
<select class="form-control" name="amount"  required id="showamount" >
