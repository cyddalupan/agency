...
<td>
<input type="submit" name="submitsearch" value="Search by Date" style="float:right;background:#1E90FF;color:white;padding:5px" >
</td>
...
echo'<td  style="color:red;font-size:16px"> '.number_format($mypeso, 2).'</td>';
