...
<div class="col-md-4 col-sm-9 col-xs-12">
<select class="form-control" name="type_payment" required <?=$test1?>>
...
<select class="form-control" name="currency"   <?=$test?>>
...
<div class="col-md-4 col-sm-9 col-xs-12">
<input type="text" class="form-control" name="description"  value="<?=$row['description']?>" <?=$test?>>
</div>
</div>
