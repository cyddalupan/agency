...
//var_dump($_POST);
insert_data('agent_agreement',$users);
$sql1="Select * From agent_agreement where agree_id= LAST_INSERT_ID()";
echo '
...
if(isset($_POST['add_set1'])){
$users = array_slice($_POST, 0, -1);
//var_dump($_POST);
insert_data('source_payment',$users);
$sql1="Select * From source_payment where s_id= LAST_INSERT_ID()";
echo '
<div class="alert alert-success">
<button type="button" class="close" data-dismiss="alert">×</button>
<strong>Successfully Added  !</strong>
...
$ifexist=mysql_query("SELECT * FROM email_address where exp_id='".$_POST['exp_id'][$lkey]."'");
$ifexistjud=mysql_num_rows($ifexist);
$field_to_insert = array( 
...
//var_dump($new_patient);
insert_data('email_address4',$new_patient,$_POST['exp_id']);
echo "Successfully Updated";
echo "</div>";
}
...
$sql1="Select * From Expenses where exexp_id= LAST_INSERT_ID()";
echo '
<div class="alert alert-success">
<button type="button" class="close" data-dismiss="alert">×</button>
