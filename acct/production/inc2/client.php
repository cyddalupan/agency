...
//var_dump($_POST);
insert_data('suppliers',$users);
$sql1="Select * From suppliers where sup_id= LAST_INSERT_ID()";
echo '
...
insert_data('suppliers',$new_patient,$_POST['sup_id']);
