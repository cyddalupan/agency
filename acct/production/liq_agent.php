...
<li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Liquidation</a>
</li>
<li role="presentation" class=""><a href="#tab_statuss" role="tab" id="profile-tab3" data-toggle="tab" aria-expanded="false">Uplaod Receipt</a>
</li>
...
<input type="date" class="form-control" name="l_date" value="" required>
</div>
</div>
