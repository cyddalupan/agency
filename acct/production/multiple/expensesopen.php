...
<h3>Office Expenses (OPEN RATE)</h3>
...
<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="https://recruitment-portal.net/jinhel/acct/production/multiple/">
...
if($row['branch_type']==7){$branchme="URDANETA";}
