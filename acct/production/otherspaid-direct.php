...
AND applicant_source IN  (5,6,8,11,16,40,57,88,97)
		...
		if ($row['fra_visa']==0  && $row['fra_deployed']==0){
		        ...
		        if($srow["status"]=="Cancelled" || $srow["status"]=="BACKOUT"  || $srow["status"]=="A to A")
                    ...
                    { 
                        ...
                        $visafinal=$agree1['agree_direct1'];
...
$reqdeployed="";   
				...
				$deployedfinal=$agree1['agree_direct2'];
...
echo "<td><input type='NUMBER' name='fra_visa[]' value='".$visafinal."' placeholder='Contract'  style='width:70px;".$border2."'  readonly></br>".$agree1['agree_direct1']." -agree</td> ";
echo "<td><input type='NUMBER' name='fra_deployed[]' value='".$deployedfinal."' placeholder='Deployed' style='width:70px;".$border3."' readonly></br>".$agree1['agree_direct2']." -agree</td> ";
