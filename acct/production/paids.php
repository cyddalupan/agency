...
<h2 sTYLE="COLOR:BLACK">SETTLED FRA REMITTANCE<SMALL><a href="paid-app.php" style="color:white;font-size:10px;background:green;padding:4px"></a></SMALL></h2>

<p style="color:black">" Note: Enter Remittance Agreement to <i style="color:red">FRA</i> "</p>
...
<A href="otherspaid.php" style="color:#DC143C">UNPAID PAYMENTS</a> |
<A href="paids.php"  style="color:#1E90FF">SETTLED PAYMENTS</a>
...
echo"<td style='font-size:9px'>NO Result</td>";
		//agree
		if ($row['fra_ftw']==0 && $cert1['certificate_medical_result']=='FIT TO WORK'){
		$ftwfinal=$agree1['agree_ftw'];
...
echo"<td style='font-size:9px'>NO Result</td>";
			//agreement
			if ($row['fra_visa']==0  && $row2['requirement_visa_no']!=""){
			$visafinal=$agree1['agree_visa'];
...
IF($row2['requirement_contract']!='0000-00-00' && $row2['requirement_contract']!='1970-01-01' )  {
...
IF($row['applicant_status']!=9 ) {
			//agreement
			if 	($row['fra_deployed']==0 && $row['applicant_status']==9){
...
echo "<td><input type='NUMBER' name='fra_sent[]' value='".$row['fra_sent']."' placeholder='SERVICE FEE' style='width:70px;".$border22222."'> </br>Agree: ".$agree1['agree_sent']."</td> ";
echo "<td><input type='NUMBER' name='fra_before[]' value='".$row['fra_before']."' placeholder='SERVICE FEE'  style='width:70px;".$border22222."'></br>Agree: ".$agree1['agree_before']."</td> ";
echo "<td><input type='NUMBER' name='fra_ftw[]' value='".$row['fra_ftw']."' placeholder='SERVICE FEE' style='width:70px;".$border1."'> </br>Agree: ".$agree1['agree_ftw']."</td> ";
echo "<td><input type='NUMBER' name='fra_visa[]' value='".$row['fra_visa']."' placeholder='SERVICE FEE'  style='width:70px;".$border2."'></br>Agree: ".$agree1['agree_visa']."</td> ";
echo "<td><input type='NUMBER' name='fra_deployed[]' value='".$row['fra_deployed']."' placeholder='SERVICE FEE' style='width:70px;".$border3."'></br>Agree: ".$agree1['agree_deployed']."</td> ";
