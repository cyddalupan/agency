...
if(isset($_POST['update_profile_auto'])){
$values="";
...
$field_to_insert = array( 
	...
	'request1' => $_POST['request1'][$lkey],
	'request2' => $_POST['request2'][$lkey],
	'request3' => $_POST['request3'][$lkey],
...
$field_to_insert = array( 
	'applicant_id' => $_POST['applicant_id'][$lkey],
	'agent_ppt' => $_POST['agent_ppt'][$lkey],
	'agent_ftw' => $_POST['agent_ftw'][$lkey],
	'agent_contract' => $_POST['agent_contract'][$lkey],
	'agent_deployed' => $_POST['agent_deployed'][$lkey],
	'applicant_paid1' => $_POST['applicant_paid1'][$lkey],
	'request1' => $_POST['request1'][$lkey],
	'request2' => $_POST['request2'][$lkey],
	'request3' => $_POST['request3'][$lkey],
