...
echo $_POST['sub_status'];
if($_POST['sub_status']=='1'){
$sub='';

}
if($_POST['sub_status']!='1'){
$sub="AND email_address2.sub_status='".$_POST['sub_status']."'";
}
...
if($_POST['status']!='1'){
$status="AND email_address2.status='".$_POST['status']."'";
}

if($_POST['counter_part']=='9999'){
$counter_part="email_address2.counter_part!=''";
}

if($_POST['counter_part']!='9999'){
$counter_part="email_address2.counter_part='".$_POST['counter_part']."'";
}
...
echo'<td style="color:red;font-size:10px">'.$row1["agent_first"].' '.$row1["agent_last"].'</td>';
