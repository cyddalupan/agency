...
<form action="reports/selected_all.php" method="post" target="_blank"class="form-horizontal form-label-left input_mask" >
...
<div class="clearfix"></div></br>
<form action="reports/deployed_all.php" method="post" target="_blank"class="form-horizontal form-label-left input_mask" >
...
<h2>Agent(s)</h2>
<div class="clearfix"></div></br>
<form action="reports/_agent.php" method="post" target="_blank">
...
<P>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="submit" class="btn btn-primary" name="reports">Generate Reports</button> </td>
</P>
</form>
