...
<li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"  style="color:blue">Expeses Info</a>
</li>
<li role="presentation" ><a href="#tab_content2" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"  style="color:blue">Liquidation Details</a>
</li>

<li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab3" data-toggle="tab" aria-expanded="false"  style="color:blue">Uplaod Receipt/Docs </a>
</li>


<li role="presentation" class=""><a href="#tab_content4" role="tab" id="profile-tab3" data-toggle="tab" aria-expanded="false" style="color:blue">Client/Supplier Attachments </a>
</li>
...
<label class="control-label col-md-3 col-sm-3 col-xs-12">SOA #</label>
...
<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" style="color:black">Request By</label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input type="text" class="form-control" name="requestby"   required  value="<?=$row['requestby']?>">
</div>
</div>

<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12" style="color:black">Created By</label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input type="text" class="form-control" name="createdby"   required  value="<?=$row['createdby']?>">
</div>
</div>
...
$app1111122222 = mysql_query("SELECT * FROM suppliers_docs where sup_id=".$sup1['sup_id']."
order by id desc");

while($row111222=mysql_fetch_array($app1111122222))
{
echo'<tr>';
echo "<td><input type='checkbox' name='delall[]' value='".$row111222['id']."' ></td> ";
echo'<td><a  href="'.$row111222["docs_fie"].'" target="_blank"><img src="'.$row111222["docs_fie"].'" style="width:100px;border:1px solid black;margin:2px">'.$row111222["docs_fie"].'</a></td>';
echo'<td>'.$row111222["docs_name"].'   </td>';
echo'</tr>';
}
