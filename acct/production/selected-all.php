...
?>
  ...
  <div class="row">
	...
	<table class="table table-bordered table-fixed" STYLE="WIDTH:80%;FONT-SIZE:11PX">
	<thead>
	<tr>
...
if($row['counter_part']=='4'){
$handled='Riza';
}

if($row['counter_part']=='6' || $row['counter_part']=='11'){
$handled='Cielo';
}

if($row['counter_part']=='5' || $row['counter_part']=='12'){
$handled='Jen';
}

if($row['counter_part']=='3'){
$handled='Bella';
}

if($row['counter_part']=='2'){
$handled='Aiza';
}
