...
where email_address2.status='".$_GET['status']."'
...
where email_address2.status='".$_GET['status']."'
AND email_address2.counter_part  IN (2)
ORDER BY email_address2.app_id desc limit 50");
}
...
where email_address2.status='".$_GET['status']."'
AND email_address2.counter_part  IN (6,11)
ORDER BY email_address2.app_id desc limit 50");
}
...
where email_address2.status='".$_GET['status']."'
AND email_address2.counter_part  IN (5,12)
ORDER BY email_address2.app_id desc limit 50");
}
...
where email_address2.status='".$_GET['status']."'
AND email_address2.counter_part  IN (3,2)
AND email_address2.user='bella'
ORDER BY email_address2.app_id desc limit 100");
}
...
echo'<td><a href="profile_applicants.php?appid='.$row['adonis'].'" STYLE="COLOR:BLUE" target="_blank">'.$row["name"].' '.$row["lname"].'</A></td>';
