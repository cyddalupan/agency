	 ...
	 ?>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
						...
						<input type="text" placeholder="First Name, Last Name" class="form-control" name="agent_name" >
						<input type="hidden" class="form-control" name="typeid" value="3">
						</div>
			...
			<option></option>';
			$set1_ = mysql_query("SELECT * FROM country ORDER BY country_id asc");
			while($setr1=mysql_fetch_array($set1_))
			{
			echo'<option value="'.$setr1["country_id"].'">'.$setr1["country_name"].'</option>';
			}
			echo'</select>';
			?>
			 </div>
			 <div class="col-md-4 col-sm-4 col-xs-12 form-group">
							...
							echo'<button type="submit" class="btn btn-warning"  name="Search" >Search</button>';
							
							?>
                        </div>
						
						<button type="button" class="btn btn-info btn-xs pull-right" data-toggle="modal" data-target="#myModal1">Add New Applcant!</button>		
...
WHERE typeid=3
order by agent_id desc limit 100");
...
echo'<td style="color:GREEN">'.number_format($totalPHP=$colphp["amounPHP"],2).' PHP </BR>
</td>';
...
echo'<td><a href="profile3.php?agent='.$row["agent_id"].'" target="_blank" style="color:blue;font-size:11px">View</a> | 
        ...
        <div class="modal-body">
			...
			<form class="form-horizontal form-label-left input_mask" method="post" action="">	
				...
				?>
					  	  ...
					  	  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Applicannt</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12">Name Applicant</label>
			<div class="col-md-9 col-sm-9 col-xs-12">
			...
			<option>'.$row["account"].'</option>';
			$set_ = mysql_query("SELECT * FROM country ORDER BY country_id asc");
			while($setr=mysql_fetch_array($set_))
			{
			echo'<option value="'.$setr["country_id"].'">'.$setr["country_name"].'</option>';
			}
			echo'</select>';
			?>
			</div>
			...
			<div class="form-group">
			<div class="col-md-12 col-sm-9 col-xs-12">	
			<button type="submit" class="btn btn-danger pull-right"  name="add_agent">Save</button>
			</div>
			</div>
