...
<?php if ( !in_array( $_SESSION['admin']['user']['user_type'], [201111]) ): ?> 
...
<li class="<?php echo controllerActive('dashboard'); ?>" style="">
<a href="https://thegrandmidoriortigas.info/agency/branch/production/" target="_blank">
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [4,2,6,25]) ): ?> 
<li>
...
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/interview.php?fil=1&&nm=For Interview"  target="_blank" >
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [23]) ): ?> 

<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="https://thegrandmidoriortigas.info/agency/excel/index.php?type=<?=$_SESSION['admin']['user']['user_type']?>"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
Welfare Staff
</a>
</li>
...
<a href="https://thegrandmidoriortigas.info/agency/excel/index.php?type=<?=$_SESSION['admin']['user']['user_type']?>"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
<span class="menu-text btn btn-warning btn-xs">Welfare SR</span>
</a>
</li>
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/interview.php?fil=1&&nm=For Interview"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
<span class="menu-text btn btn-warning btn-xs">Welfare Interview</span>
</a>
</li>
...
<a href="https://thegrandmidoriortigas.info/agency/excel/index.php?type=<?=$_SESSION['admin']['user']['user_type']?>"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
<span class="menu-text btn btn-warning btn-xs">Welfare Head</span>
</a>
</li>
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [34]) ): ?> 
...
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/view_branch.php?imy=<?=$_SESSION['admin']['user']['branch_id']?>&&user=<?=$_SESSION['admin']['user']['user_id']?>"  target="_blank">
<i class="menu-icon fa fa-file"></i>
<span class="menu-text btn btn-info btn-xs"> Branch Applicants</span>
</a>
</li>
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/view_branch_w.php?imy=<?=$_SESSION['admin']['user']['branch_id']?>&&user=<?=$_SESSION['admin']['user']['user_id']?>"  target="_blank">
<i class="menu-icon fa fa-file"></i>
<span class="menu-text btn btn-info btn-xs">Waitlist</span>
</a>
</li>
...
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/view_branch_ro.php?imy=<?=$_SESSION['admin']['user']['userassign']?>"  target="_blank"> My applicant</a>
</li>

<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/waitlist_ro.php?imy=<?=$_SESSION['admin']['user']['userassign']?>"  target="_blank"> WAITLIST</a>
</li>

<li>
<i class="menu-icon fa fa-file"></i>
<span class="menu-text btn btn-info btn-xs"> R.O Applicants</span>
</a>
</li>
...
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/view_bc.php?user=<?=$_SESSION['admin']['user']['user_id']?>"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
<span class="menu-text btn btn-danger btn-xs"> My Applicant</span>
</a>
</li>
...
<!-- Employers -->
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [3,4,6,13]) ): ?>
...
<!-- Agencies / Agents -->
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [3,4,6,2,8,20,25]) ): ?>
...
<!-- Commission -->
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [2, 8, 4,25]) ): ?>
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [2, 4, 8,25]) ): ?>
<!-- Accounting Reports -->
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [3,4,25]) ): ?>
...
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="https://thegrandmidoriortigas.info/agency/login/" style="color:red" target="_blank">
<i class="menu-icon fa fa-sign"></i>
<span class="menu-text" > System Login</span>
</a>
</li>
