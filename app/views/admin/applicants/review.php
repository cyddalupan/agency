...
<br><br>
<b style="text-transform: uppercase;font-size:14px;color:green"> <?php echo $applicant_raw->accomodation1; ?></b>
...
<?php if (!in_array( $_SESSION['admin']['user']['user_type'], [1,11,12,9999]) ): ?>
...
<?php if (!in_array( $_SESSION['admin']['user']['user_type'], [1,11,9999]) ): ?>
...
<a href="https://thegrandmidoriortigas.info/agency/others/resume.php?appid=<?=$applicant['applicant_id']?>" class="btn btn-sm btn-default" target="_blank">Download PDF Skilled</a>
<?php } ?>
