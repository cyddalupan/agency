                            ...
                            <div class="widget flat radius-bordered">
                                <div class="widget-header bg-blue">
                                    <span class="widget-caption">
                                        <a href="<?php echo site_url( 'admin/billing/employer-soa/'.$employer['employer_slug'] ); ?>" class="btn btn-xs btn-default">&laquo;Back</a>
                                    </span>
                                </div>
                                    ...
                                    <table class="table table-hover table-condensed">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="fee-amount">&#8369;&nbsp;<span class="text-danger"><?php echo number_format( $fee['detail_employer_cost'] - $fee['detail_employer_deposit'], 2 ); ?></span></p>
                                                </td>
                                                <td>
                                                ...
                                                <td> 
                                                    <div class="input-group col-sm-6">
                                                      ...
                                                      <input name="payment[fee][<?php echo $feeId; ?>]" type="number" class="form-control fee-amount" placeholder="0.00" max="<?php echo $fee['detail_employer_cost'] - $fee['detail_employer_deposit']; ?>" min="0"> 
                                                    </div>                                                     
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
