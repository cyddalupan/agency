...
<form method="post" class="form" action="<?php echo site_url( 'admin/reports/recruitment-agents-deployed-applicants' ); ?>" target="_blank">
<div class="modal-body">
    <div class="bootbox-body">
    	<div class="row">			
			...
			<div class="col-sm-5">
				<select name="applicant[agent]" class="form-control">
