...
<div class="pull-right" style="padding:2px;font-size:11px;padding:8px;border:1px solid lightgray;color:black">
<b style="color:Red"><a href="http://promesa.recruitmensys.com/promesa/others/lineup-clear.php?appid=<?=$applicant['applicant_id']?>" target="_blank" style="color:Red">Clear lineup</a></b>
</div>
...
<?php if (!in_array( $_SESSION['admin']['user']['user_type'], [1,11,12,9999,17,20]) ): ?>
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [ 3,4, 6, 7,9,10,13]) ): ?>
...
<?php if (!in_array( $_SESSION['admin']['user']['user_type'], [1,11,17,9999,20]) ): ?>
...
<h5 style="font-weight:bold;padding:8px">BEAUTY CARE</h5>
...
<span class="text">English Fluentممتاز</span>
</label>
</div>
</div>
</div>
...
<span class="text">English Fair  متوسط</span>
</label>
</div>
</div>
</div>
...
<span class="text">ARABIC Fluentممتاز</span>
</label>
</div>
</div>
</div>
...
<span class="input-icon icon-right">
<div class="input-group">
<input name="applicant[basic][date-interview]" type="date" data-date-format="yyyy-mm-dd" class="form-control date-picker" placeholder="yyyy-mm-dd" value="<?php echo $applicant_raw->applicant_date_interview; ?>">
</div>
</span>
</div>
</div>
...
<option value="FIT TO WORK" <?php echo $applicant['certificate_medical_result'] == 'FOR MEDICAL' ? 'selected' : ''; ?>>FOR MEDICAL</option>
...
<input name="applicant[certificate][pdos_no]" type="text"  class="form-control date-picker"  value=" <?php echo $applicant_certificate_direct->certificate_pdos_no; ?>"  style="border:2px solid red">
...
<input type="text" name="applicant[certificate][owwanumber]" class="form-control" placeholder="" value="<?php echo $applicant_certificate_direct->owwa_number; ?>">
...
<input name="applicant[requirement][visa-date]" type="date" data-date-format="yyyy-mm-dd" class="form-control cyd-visa-date" placeholder="yyyy-mm-dd" value="<?php echo fdate( 'Y-m-d', $applicant['requirement_visa_date'], '0000-00-00' ); ?>"  onchange="changeVisaDuration()">
</div>
</span>
</div>
</div>
...
<div class="col-sm-2">
<div class="form-group">
<label>Visa Stamp Release</label>
<span class="input-icon icon-right">
<div class="input-group">
<input  name="applicant[requirement][visa-stamp]" type="date" data-date-format="yyyy-mm-dd" class="form-control" placeholder="yyyy-mm-dd" value="<?=$applicant_requirements_direct->requirement_visa_stamp?>" <?=$visadata?>  style="border:2px solid red">
</div>
</span>
</div>
</div>
...
<option value="30" <?php if($applicant_requirements_direct->visa_duration == 30)echo 'selected'; ?>>30 Days</option>
<option value="60" <?php if($applicant_requirements_direct->visa_duration == 60)echo 'selected'; ?>>60 Days</option>
<option value="90" <?php if($applicant_requirements_direct->visa_duration == 90)echo 'selected'; ?>>90 Days</option>
<option value="182" <?php if($applicant_requirements_direct->visa_duration == 182)echo 'selected'; ?>>6 Months</option>
</select>
</div>
...
<span class="input-icon icon-right">
<div class="input-group">
<input name="applicant[requirement][visa-expiration]" type="date" data-date-format="yyyy-mm-dd" class="form-control visa-date-expired" placeholder="yyyy-mm-dd" value="<?php echo fdate( 'Y-m-d', $applicant['requirement_visa_expiration'], '0000-00-00' ); ?>">
</div>
</span>
</div>
</div>
...
<div class="col-sm-2 coordination-col">
<div class="form-group">
<label>EWAKALA</label>
...
<select name="applicant[requirement][vfs]" class="form-control">
<option><?php echo $applicant_requirements_direct->vfs; ?></option>
...
<input type="text" name="applicant[requirement][eregd]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->applicant_requirement_eregd	; ?>">
</div>
</div>
...
<input type="date" name="applicant[requirement][transnum]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->transnum	; ?>">
</div>
</div>
...
<span class="input-icon icon-right">
<div class="input-group">
<input  name="applicant[requirement][contract]" type="date"  class="form-control" data-date-format="yyyy-mm-dd" value="<?=$applicant['requirement_contract']?>"  <?=$contractme?>  style="border:2px solid red">
</div>
</span>
</div>
</div>
...
value="<?php echo $applicant_requirements_direct->requirement_contract_sign; ?>" <?=$contractmesign?> style="border:2px solid red">
...
<span class="input-icon icon-right">
<div class="input-group">
<input name="applicant[requirement][requirement_musaned_approved]" type="date" data-date-format="yyyy-mm-dd" class="form-control date-picker" placeholder="yyyy-mm-dd" value="<?php echo fdate( 'Y-m-d', $applicant_requirements_direct->requirement_musaned_approved, '0000-00-00' ); ?>">
</div>
</span>
</div>
</div>
...
<span class="input-icon icon-right">
<div class="input-group">
<input name="applicant[requirement][requirement_musaned_sign]" type="date" data-date-format="yyyy-mm-dd" class="form-control date-picker" placeholder="yyyy-mm-dd" value="<?php echo fdate( 'Y-m-d', $applicant_requirements_direct->requirement_musaned_sign, '0000-00-00' ); ?>">
</div>
</span>
</div>
</div>
...
<div class="col-sm-2">
<div class="form-group">
<label>Flight<b style="color:Red">+</b><!--ticket remarks--></label>
<input type="text" name="applicant[requirement][ticket_plus]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->ticket_plus; ?>">
</div>
</div>
...
<strong>Applicant Deployment Info</strong>
</div>
...
<option value="<?php echo $statusId; ?>" <?php echo $statusId == $applicant['status']['status'] ? 'selected' : ''; ?> <?php echo $statusId == $status['Deployed'] && ! $applicant['applicant_job'] ? '' : ''; ?>><?php echo $string; ?><?php echo $statusId == $status['Deployed'] && ! $applicant['applicant_job'] ? ' (No selected job)' : ''; ?></option>
...
<option>With Transmittal</option>
...
<option>For Biometric Schedule</option>
<option>With Biometric Schedule</option>
<option>For Visa Stamping</option>
<option>Done Stamped </option>
<option>Done OEC</option>
