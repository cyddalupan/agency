           ...
           <div class="row">
              <div class="col-md-12">
                 ...
                 <div class="hero">
                    ...
                    <h3><span> With Ticket Applicants</span></h3>
                    <!-- para -->
                 </div> 
...
<button type="submit" class="btn btn-info"  name="Search" >Search </button>
  ...
  <table class="table table-hover table-striped table-bordered" style="margin-left:-250px">
<thead>
<tr>
<th >#</th>
<th >Name</th>
...
if(isset($_POST['Search']))
{
	...
	and  LIKE applicant_first '%'".$_POST['mydata']."'%' or applicant_last '%'".$_POST['mydata']."'%'
	order by applicant_updated desc";
	$row1 = $conn->query($app);
	$flightrowdate="";
