...
$inserts=mysql_query("insert into applicant_log (log_applicant,log_remarks,log_employer,log_created,log_date,log_createdby,log_status) values
(".$_POST['applicant_id'].",'Employer Remarks:".$_POST['employer_remarks']."','".$_POST['employer']."','".$_POST['date1']."','".$_POST['date1']."','".$_POST['employer']."','".$_POST['log_status']."')");			
