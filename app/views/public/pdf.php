...
<div class="gradient" style="text-align:center;border-bottom:0px solid black;padding:2px">
    <img src="{banner}" style="width: 90%; margin-top: -40pt; "  height="100" />
</div>
...
<div class="clearfix"></div>
<div class="" style="width: 100%;margin-top: -22pt;">
    <table cellspacing="0">
        
        <tr>
			<td style="text-align:LEFT;color:black;width:120px;font-weight:bold;background:#DAA520;font-size:13px">Full Name <div class="clearfix"></div> الإســـــم بالكامل </td>
		    <td style="text-align:LEFT;font-size:13px;border-right:0px;border-LEFT:0px;width:200px;" colspan="2">{fname} {mname} {lname}</td>
		<td style="text-align:LEFT;color:black;width:110px;font-weight:bold;background:#DAA520">Position <div class="clearfix"></div> الراتب  :</td>
 ...
 <div class="" style="float:left; width: 60%;argin-bottom: 2pt; ">
	...
	<table cellspacing="0" cellpadding="1">
			...
			<tr >
                ...
                <td>400 USD</td>
				<td style="color:#b33c00">الراتب الشهري</td>
            </tr>
				<tr >
                <th style="color:#b33c00;width:100px">Mobile #:</th>
                <td> {contact}</td>
				<td style="color:#b33c00">المدة العقد</td>
            </tr>
			...
			<tr >
                ...
                <td>2 Years</td>
				<td style="color:#b33c00"> مدة العقد :</td>
            </tr>
			
			<tr >
                <th  style="color:#b33c00">Passport #:</th>
                <td>{passport_number}</td>
				<td style="color:#b33c00">رقم الجواز</td>
            </tr>
			...
			<tr >
                <th style="color:black;width:150px;background:#DAA520;text-align:center;font-size:12px" colspan="3">
				Personal Details                               بيانات صاحب الطلب</th>
            </tr>
			
			<tr >
                <th  style="color:#b33c00">NATIONALITY:</th>
                <td>{applicant_nationality}</td>
				<td style="color:#b33c00">الجنسية</td>
            </tr>
			...
			<tr >
				...
				<td style="color:#b33c00">لحالة الاجتماعيه</td>
            </tr>
			
			<tr >
                <th  style="color:#b33c00">No. of Children:</th>
                <td>{applicant_children}</td>
				<td style="color:#b33c00">عدد الأطفال</td>
            </tr>
			...
			<tr >
                ...
                <td>{edu}</td>
				<td style="color:#b33c00">المستوى التعليمي </td>
            </tr>
...
<div class="clearfix"></div>
 ...
 <h3 style="background:#DAA520;padding:3px;margin-top: -20pt;font-size:12x " >Previous employment(Abroad):الخبرة السابقة خارج البلد </h3>
{work_experiences}
...
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PX;text-transform: uppercase;font-weight:bold">Fluentممتاز</td>
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">Fair  متوسط</td>
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">Poorلا شي</td>
</tr>
...
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">{read_e}</td>
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">{speak_e}</td>
</tr>

<tr >
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PX;text-transform: uppercase;font-weight:bold">ARABIC</td>
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">{read_a}</td>
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">{write_a}</td>
<td colspan="6" STYLE="TEXT-ALIGN:LEFT;font-size:12PXtext-transform: uppercase;font-weight:bold">{speak_a}</td>
</tr>
	...
	<table cellspacing="0" cellpadding="1">
			...
			<tr >
                ...
                <td>{ironing}</td>
				<td style="color:#b33c00">كى الملابس</td>
				
				<th style="color:#b33c00;width:150px">Baby Sitting:</th>
                <td>{baby_sitting}</td>
				<td style="color:#b33c00">يجلس الطفل</td>
                ...
                <td>{cooking}</td>
				<td style="color:#b33c00">طبخ</td>
				
				<th style="color:#b33c00;width:150px">Children Care :</th>
                <td>{children_care}</td>
				<td style="color:#b33c00">رعاية الأطفال</td>
				...
				<td style="color:#b33c00">الطبخ العربي</td>
				
				<th style="color:#b33c00;width:150px">Tutoring:</th>
                <td>{tutoring}</td>
				<td style="color:#b33c00">أطفال تعليمي</td>
			...
			<tr >
                ...
                <td>{sewing}</td>
				<td style="color:#b33c00">خياطة</td>
				
				<th style="color:#b33c00;width:150px">Cleaning:</th>
                <td>{cleaning}</td>
				<td style="color:#b33c00">تنظيف المنزل</td>
				
            </tr>
			
			
			<tr >
                <th style="color:#b33c00;width:150px">Computer:</th>
                <td>{computer}</td>
				<td style="color:#b33c00"></td>
				
				<th style="color:#b33c00;width:150px">Washing:</th>
                <td>{washing}</td>
				<td style="color:#b33c00">غسل</td>
