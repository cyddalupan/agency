...
<form id="frmUploadPhoto" class="form-except" method="post" enctype="multipart/form-data" action="<?php echo site_url('skilled/update_profile') ?>">
...
<form id="frmApplicantReview" class="form" role="form" method="post" enctype="multipart/form-data" action="<?php echo site_url('skilled/update_profile'); ?>">
...
<select name="applicant[basic][applicant_ex]" class="form-control" required>
...
<input type="text" name="applicant[basic][middle]" class="form-control" placeholder="if no Middle Name put NMN" value="<?php echo $applicant['applicant_middle']; ?>" >
...
<input type="text" name="applicant[basic][age]" class="form-control" placeholder="Last" value="<?php echo $applicant['applicant_age']; ?>" required>
...
<input type="number" name="applicant[basic][height]" class="form-control" placeholder="Height (CM)" value="<?php echo isset( $post['applicant']['basic']['height'] ) ? $post['applicant']['basic']['height'] : $applicant['applicant_height']; ?>">
...
<input type="number" name="applicant[basic][weight]" class="form-control" placeholder="Weight (KG)" value="<?php echo isset( $post['applicant']['basic']['weight'] ) ? $post['applicant']['basic']['weight'] : $applicant['applicant_weight']; ?>">
...
<input type="text" name="applicant[basic][contacts4]" class="form-control" placeholder="" value="<?php echo isset( $post['applicant']['basic']['contacts4'] ) ? $post['applicant']['basic']['contacts4'] : $applicant_raw->applicant_contacts_4; ?>" />
...
<select name="applicant[education][others]" class="form-control">
<option> <?php echo $applicant['education_others']; ?></option>
...
<label>What level did you reach ?</label>
...
<label>ARE YOU A COLLEGE LEVEL OR COLLEGE GRADUATE? </label>
<select name="applicant[education][mba]" class="form-control">
<option> <?php echo $applicant['education_mba']; ?></option>
<option>YES</option>
<option>NO</option>
</select>
...
<div class="clearfix"></div>
<div class="col-sm-6" style="" required>
<div class="form-group">
<label> Did you take a training to get TESDA NCII Domestic Worker Certificate before? </label>
...
<div class="col-sm-6" style="" required>
<div class="form-group">
<label> Did you pass the exam to get TESDA NCII Domestic Worker Certificate before?</label>
<select name="applicant[basic][remarks1]" class="form-control">
<option> <?php echo $applicant_raw->applicant_remarks1; ?></option>
<option>YES</option>
<option>NO</option>
</select>
</div>
...
if($skillcyd[0]->tutoring == 1)        $skillcyd['tutoring']       = 'checked';
if($skillcyd[0]->cleaning == 1)        $skillcyd['cleaning']       = 'checked';
if($skillcyd[0]->washing == 1)         $skillcyd['washing']        = 'checked';
if($skillcyd[0]->manicure == 1)         $skillcyd['manicure']        = 'checked';
if($skillcyd[0]->massage == 1)         $skillcyd['massage']        = 'checked';
if($skillcyd[0]->coloring == 1)         $skillcyd['coloring']        = 'checked';
if($skillcyd[0]->blower == 1)         $skillcyd['blower']        = 'checked';
if($skillcyd[0]->write_e == 1)         $skillcyd['write_e']        = 'checked';
if($skill_cyd[0]->read_e == 1)         $skillcyd['read_e']        = 'checked';
if($skill_cyd[0]->speak_e == 1)         $skillcyd['speak_e']        = 'checked';
if($skillcyd[0]->read_a == 1)         $skillcyd['read_a']        = 'checked';
if($skillcyd[0]->write_a == 1)         $skillcyd['write_a']        = 'checked';
if($skillcyd[0]->speak_a == 1)         $skillcyd['speak_a']        = 'checked';
}
?>
<div class="row">
<div class="col-sm-2">
...
<div class="col-sm-2">
<div class="form-group">
<label>(POOR,FAIR,GOOD) </label>
<select name="applicant[basic][applicant_engslish]" class="form-control">
<option> <?php echo $applicant_raw->applicant_engslish; ?></option>
<option>POOR</option>
<option>FAIR</option>
<option>GOOD</option>
</select>
...
<label>(POOR,FAIR,GOOD) </label>
<select name="applicant[basic][applicant_arabic]" class="form-control">
<option> <?php echo $applicant_raw->applicant_arabic; ?></option>
<option>POOR</option>
<option>FAIR</option>
<option>GOOD</option>
</select>
...
<label></em></small></label>

<input  type="hidden"name="applicant[other-skills]"  placeholder="Type skills" value="" />
...
if($applicant_raw->typess==0){$branchme="N/A";}
if($applicant_raw->typess==1){$branchme=" MAIN OFFICE";}
if($applicant_raw->typess==2){$branchme="Aklan BRANCH";}
if($applicant_raw->typess==3){$branchme="Calapan BRANCH";}
if($applicant_raw->typess==4){$branchme="Cagayan BRANCH";}
if($applicant_raw->typess==5){$branchme="Davao BRANCH";}
if($applicant_raw->typess==6){$branchme="Leyte BRANCH";}
if($applicant_raw->typess==7){$branchme="Lucena BRANCH ";}
if($applicant_raw->typess==8){$branchme="Pangasinan BRANCH";}

if($applicant_raw->typess1==0){$branchme1="N/A";}
if($applicant_raw->typess1==1){$branchme1=" MAIN OFFICE";}
if($applicant_raw->typess1==2){$branchme1="Aklan BRANCH";}
if($applicant_raw->typess1==3){$branchme1="Calapan BRANCH";}
if($applicant_raw->typess1==4){$branchme1="Cagayan BRANCH";}
if($applicant_raw->typess1==5){$branchme1="Davao BRANCH";}
if($applicant_raw->typess1==6){$branchme1="Leyte BRANCH";}
if($applicant_raw->typess1==7){$branchme1="Lucena BRANCH ";}
if($applicant_raw->typess1==8){$branchme1="Pangasinan BRANCH";}
...
<select name="applicant[basic][typess1]" class="form-control">
<option value="<?php echo $applicant_raw->typess1;?>"><?php echo $branchme1; ?>-<?php echo $applicant_raw->typess1;?></option>
<option VALUE="1"> MAIN OFFICE</option>
<option VALUE="2">Aklan BRANCH</option>
<option VALUE="3">Calapan BRANCH</option>
<option VALUE="4">Cagayan Valley BRANCH </option>
...
<input name="applicant[source]" type="HIDDEN" value="<?=$applicant['applicant_source']?>" readonly>
...
<div style="clear:both;height:10px"></div>
<h3 style="font-weight:bold;padding:8px;COLOR:black;margin:20px"><B>MEDICAL HISTORY</B></h3>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have tattoo?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t1]" class="form-control" value="<?php echo $applicant_raw->t1; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have Hemmorhoids?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t2]" class="form-control" value="<?php echo $applicant_raw->t2; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have Diabetes?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t3]" class="form-control" value="<?php echo $applicant_raw->t3; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have High Blood?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t4]" class="form-control" value="<?php echo $applicant_raw->t4; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have Heart Problem?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t5]" class="form-control" value="<?php echo $applicant_raw->t5; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have Allergies?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t6]" class="form-control" value="<?php echo $applicant_raw->t6; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have Cyst?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t7]" class="form-control" value="<?php echo $applicant_raw->t7; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<div class="col-sm-3">
<div class="form-group">
<label>Do you have Asthma?</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][t8]" class="form-control" value="<?php echo $applicant_raw->t8; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<H6 style="font-weight:bold;padding:8px;COLOR:black;margin:20px"><B>DO YOU HAVE TATTOO? WHERE ARE THE LOCATION</B></H6>
<div class="col-sm-2"  style="">
<div class="form-group">
<div class="checkbox">
<label>
...
<div class="col-sm-6">
<div class="form-group">
<label>Others</em></small></label>
<span class="input-icon icon-right">
<input type="text" name="applicant[basic][applicant_jobs]" class="form-control" value="<?php echo $applicant_raw->applicant_jobs; ?>">
<i class="fa fa-briefcase darkorange"></i>
</span>
<!--<p class="help-block">Write some remarks</p>-->
</div>
...
<form class="form" role="form" method="post" enctype="multipart/form-data" action="<?php echo site_url('skilled/update_profile'); ?>">
...
<a target='_blank'  href="https://thegrandmidoriortigas.info/agency/others/medical_history.php?idme=<?=$applicant['applicant_id']?>&&user=<?=$_SESSION['admin']['user']['user_fullname']?>" style="font-size:18px;font-weight:bold;color:#DC143C">Update Medical </a> 
<div style="clear:both;height:15px"></div>
...
<?php if($applicant_certificate_direct->localflight1=='ARRIVED')  {?>
                ...
                <input type="date" name="applicant[certificate][localflight]" class="form-control" placeholder="" value="<?php echo $applicant_certificate_direct->localflight; ?>" readonly>
                </div>
                </div>
                ...
                <div class="form-group">
                <label>Local Flight</label>
                <select name="applicant[certificate][localflight1]" class="form-control" disabled>
                <option> <?php echo $applicant_certificate_direct->localflight1; ?></option>
                <option>NO SHOW</option>
                <option>FOR DEPARTURE</option>
...
<?php if ( !in_array( $_SESSION['admin']['user']['user_type'], [17]) ): ?> 
                ...
                <div class="form-group">
                <label>Local Flight</label>
                <select name="applicant[certificate][localflight1]" class="form-control">
                <option> <?php echo $applicant_certificate_direct->localflight1; ?></option>
                <option>NO SHOW</option>
                <option>FOR DEPARTURE</option>
                <option>ARRIVED</option>
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [32,33,4]) ): ?> 
<div class="col-sm-2 owwa-from-col">
<div class="form-group">
<label>Welfare Interview </label>
<select name="applicant[certificate][localflight2]" class="form-control" >
<option> <?php echo $applicant_certificate_direct->localflight2; ?></option>
<option>Approved</option>
<option>Did not appear</option>
...
<div class="form-group">
<label>Welfare Interview </label>
<select name="applicant[certificate][localflight2]" class="form-control" disabled>
<option> <?php echo $applicant_certificate_direct->localflight2; ?></option>
<option>Approved</option>
<option>Did not appear</option>
<option>Reject</option>
