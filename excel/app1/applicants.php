                        ...
                        <table id="cyd_applicant_list" class="table table-bordered table-hover table-applicants">
                            ...
                            <tbody>
                                ...
                                <tr class="<?php echo in_array( $_SESSION['admin']['user']['user_type'], [7]) ? 'record-except' : ''; ?>">
                                    ...
                                    <td class="numeric">
                                       <?php echo str_pad( $applicant['applicant_id'], 7, '0', STR_PAD_LEFT ); ?> 
                                    </td>
									  <td class="numeric">
                                       <?php echo $applicant['applicantNumber']; ?> 
                                    </td>
                                    ...
                                    <td>
                                        <?php echo ! is_null( $applicant['employer_names'] ) ? $applicant['employer_names'].$applicant['remove_employer_link'] : '--'; ?> 
                                    </td>
                                    <td>
