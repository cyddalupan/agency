                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="form-group">
                            	<label for="user[fullname]">Branch ID</label>
                                <input name="user[branch]" type="text" placeholder="Full name" class="form-control" value="" >
                            </div>
...
<div class="form-group">
<label for="user[name]">Case Password</label>
<input name="user[password]" type="text" placeholder="Username" class="form-control" value="" style="text-transform:lowercase"  required>
</div>

<div class="form-group">
<label for="user[name]">Branch_id</label>
<input name="user[branch_id]" type="text" placeholder="Username" class="form-control" value="" style="text-transform:lowercase"  required>
</div>
