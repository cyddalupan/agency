...
<img src="'.base_url().$fileWholeBody['file_path'].'" style="height:425px; " />
...
'<table cellspacing="0" cellpadding="1">
<tr >
<th style="width:200px">Educational Level: </th>
...
'applicant_mothers'        => $this->emptest($applicant_alphatomo->applicant_mothers),
