                        ...
                        <table class="table table-bordered table-hover table-applicants">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td>
										<?php if (  $applicant['requirement_owwa_schedule'] != '-0001-11-30' ): ?>
									...
									<?php
										if(isset($applicant_requirement_raw))
                                            echo fdate('d-M-Y', $applicant_requirement_raw[$applicant['applicant_id']]->requirement_visa_stamp,'---');
										?>
                                      
                                    </td>
									
									<td>
										<?php if (  $applicant['requirement_visa_release_date'] != '-0001-11-30' ): ?>
									...
									<td>
										<?php if (  $applicant['requirement_oec_submission_date'] != '-0001-11-30' ): ?>
									...
									<td>
										<?php if (  $applicant['requirement_oec_release_date'] != '-0001-11-30' ): ?>
									...
									<td>
										...
										<?php
										if(isset($applicant_requirement_raw))
                                            echo fdate('d-M-Y', $applicant_requirement_raw[$applicant['applicant_id']]->flight_date,'---');
										?>
                                    </td>
