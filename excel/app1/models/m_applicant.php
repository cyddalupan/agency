...
'applicant_by_interview'			   => $applicant['applicant_by_interview'],
'typess'			   => $applicant['typess'],
...
'highest1'	=>  $basic['highest1'],
'applicant_remarks1'	=>  	$basic['remarks1'],
'applicant_remarks5'	=>  	$basic['remarks5'],
'applicant_remarks6'	=>  	$basic['remarks6'],
...
'certificate_peosd'     => date( 'Y-m-d H:i:s', strtotime( $certificate['peosd'] ) ),
'certificate_philhealth'         => isset( $certificate['philhealth'] ),
'certificate_m1b'                => isset( $certificate['m1b'] ),
'certificate_tor'                => isset( $certificate['tor'] ),
'certificate_peos'                => isset( $certificate['peos'] ),
'certificate_ereg'                => isset( $certificate['ereg'] ),
'certificate_prc_cert'           => isset( $certificate['prc_cert'] ),
'certificate_prc_id'             => $certificate['prc_id'] ,
'certificate_prc_rating'         => $certificate['prc_rating'],
'certificate_coe'                => $certificate['coe'] ,
'certificate_bc'                 => isset( $certificate['bc'] ),
'certificate_mc'                 =>isset( $certificate['mc'] ),
...
])->update( 'applicant_requirement', [ 'covidme' => $certificate['covidme'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covid_name' => $certificate['covid_name'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covid_date' => $certificate['covid_date'] ] );

//Update covid4
$this->db->flush_cache();
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covid_date2' => $certificate['covid_date2'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covid_loc' => $certificate['covid_loc'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covid_yellow' => $certificate['covid_yellow'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covid_cert' => $certificate['covid_cert'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covidb1' => $certificate['covidb1'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covidb2' => $certificate['covidb2'] ] );
...
$this->db->where([
'requirement_applicant' => $applicantId,
])->update( 'applicant_requirement', [ 'covidb3' => $certificate['covidb3'] ] );
...
'insurance1'			              => $requirement['insurance1'],
'insurance2'			              => $requirement['insurance2'],
'insurance4'			              => $requirement['insurance3'],
