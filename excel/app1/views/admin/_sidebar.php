...
<?php if ( !in_array( $_SESSION['admin']['user']['user_type'], [20,13]) ): ?> 
...
<?PHP  IF($_SESSION['admin']['user']['payments']=='Yes') { ?>
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [22,21]) ): ?> 
...
<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="<?=$mylink?>others/view_lo.php?user=<?=$_SESSION['admin']['user']['user_id']?>"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
  <span class="menu-text btn btn-danger btn-xs">Applicants</span>
</a>
</li>
...
<?php if ( in_array( $_SESSION['admin']['user']['user_type'], [23,2,4]) ): ?> 



<li class="<?php echo controllerActive('dashboard'); ?>">
<a href="http://iwebframework.com/globalpro/excel/index.php"  target="_blank" >
<i class="menu-icon fa fa-folder"></i>
  <span class="menu-text btn btn-warning btn-xs">Welfare System</span>
</a>
</li>
...
<a href="#" class="menu-dropdown">
<i class="menu-icon fa fa-bookmark"></i>
<span class="menu-text">  Skilled</span>
<i class="menu-expand"></i>
</a>
...
<span class="menu-text">Agent/Partner/Other Source </span>
<i class="menu-expand"></i>
</a>
...
<span class="menu-text">Add Agent/Partner/Other</span>
</a>
</li>
</ul>
</li>
...
<!-- Settings -->
<li class="<?php echo controllerActive('settings', true); ?>"><?php if ( in_array( $_SESSION['admin']['user']['user_type'], [3,4]) ): ?>
