...
<?php if($applicant['applicant_position_type']!='Skilled'){  $myhidedata=""; };
if($applicant['applicant_position_type']=='Skilled'){  $myhidedata="display:none"; };
?>
...
<?php if($applicant['applicant_position_type']!='Skilled'){ ?>
			...
			<p style="color:black;FONT-WEIGHT:bold;font-size:14px;width:300px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; TESDA : 
			...
			{   }
			else { echo fdate( 'd F Y', $applicant_certificate_direct->certificate_tesda_date, '0000-00-00');}
			?>
			
			</p>

			<p  style="color:black;FONT-WEIGHT:bold;font-size:14px;width:290px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;  OWWA : 
			...
			{  }
			else { echo fdate( 'd F Y', $applicant_certificate_direct->certificate_owwa_from, '0000-00-00');  }
			?>
			
			</p>


			<p  style="color:black;FONT-WEIGHT:bold;font-size:14px;width:230px"> BIOMETRICS :
			...
			{  }
			else { echo fdate( 'd F Y', $applicant_requirements_direct->vfs, '0000-00-00');  }
			?>
			</p>
<?php } ?>
...
<?php if($applicant['applicant_position_type']=='Skilled'){ ?>
<a href="http://iwebframework.com/globalpro/others/resume.php?appid=<?=$applicant['applicant_id']?>" class="btn btn-sm btn-default" target="_blank">Download PDF Skilled</a>
<?php } ?>

<?php if($applicant['applicant_position_type']=='Household'){ ?>
<a href="<?php echo site_url( 'public/applicants/pdf/'.$applicant['applicant_slug'] ); ?>" class="btn btn-sm btn-default" target="_blank">Download CV</a>
<?php } ?>

<div class="stats-value pink">
 </BR>
<b style="text-transform: uppercase;font-size:16px"> <?php echo $applicant['employer_name']; ?> </b>
...
<a data-toggle="tab" href="#profile" style="font-size:20px;color:black;font-weight:bold;text-transform:uppercase">
Profile
</a>
</li>
...
<a data-toggle="tab" href="#certifications"  style="font-size:20px;color:black;font-weight:bold;text-transform:uppercase">
...
<a data-toggle="tab" href="#requirements"  style="font-size:20px;color:black;font-weight:bold;text-transform:uppercase">
...
<a data-toggle="tab" href="#documents"  style="font-size:20px;color:black;font-weight:bold;text-transform:uppercase">
...
<a data-toggle="tab" href="#status"  style="font-size:20px;color:black;font-weight:bold;text-transform:uppercase">
...
<option><?php echo $applicant_raw->currency; ?></option>
...
<input type="text" name="applicant[education][others]" class="form-control" placeholder="COURSE"  value="<?php echo isset( $post['applicant']['education']['others'] ) ? $post['applicant']['education']['others'] : $applicant['education_others']; ?>">
...
<input name="applicant[basic][highest1]" type="text" class="form-control"  value="<?php echo $applicant_raw->highest1; ?>">
</div>
...
Skills & Languages<span>( <a href="#" class="btn-change-designation" data-target=".other-skills-container"> Edit <i class="fa fa-pencil"></i> </a> )</span>
...
?>
<div class="row">
<div class="col-sm-2" style="<?=$myhidedata?>">
<div class="form-group">
<div class="checkbox">
<label>
...
<span class="text">Caregiver of Ill Person</span>
</label>
</div>
</div>
</div>
...
<span class="text">Taking Care of Elderly</span>
</label>
</div>
</div>
</div>
...
<h5 style="font-weight:bold;padding:8px">Languages</h5>
...
<hr class="wide">
<div class="form-title" style="<?=$myhidedata?>">
...
<hr class="wide">
<div class="form-title" style="<?=$myhidedata?>">
Working Ability <span>( <a href="#" class="btn-change-education" data-target=".future-plans2">Edit <i class="fa fa-pencil"></i></a> )</span>
<div class="clearfix"></div>
</div>
<div class="future-plans2 hide">
<div class="row">
<div class="col-sm-10">
<div class="form-group">
<label>State five (5) household duties that you can perform very efficiently</label>
<span class="input-icon icon-right">
<textarea name="applicant[basic][remarks5]" class="form-control auto-text-area" spellcheck="false" rows="4" placeholder="Write some remarks..."><?php echo $applicant_raw->applicant_remarks5; ?></textarea>
</span>
</div>
</div>
</div>
...
<span class="input-icon icon-right">
<textarea name="applicant[basic][remarks6]" class="form-control auto-text-area" spellcheck="false" rows="4" placeholder="Write some remarks..."><?php echo $applicant_raw->applicant_remarks6; ?></textarea>
</span>
</div>
</div>
</div>
...
<hr class="wide">
<div class="form-title" style="display:none">
Future Plans <span>( <a href="#" class="btn-change-education" data-target=".future-plans111">Edit <i class="fa fa-pencil"></i></a> )</span>
<div class="clearfix"></div>
</div>
<div class="future-plans11 hide" style="display:none">
<div class="row">
<div class="col-sm-10">
<div class="form-group">
<label>Why do you want to go and work overseas?</label>
...
<?php
if($applicant_raw->typess==1){$branchme="MAIN";}
if($applicant_raw->typess==2){$branchme="ILOILO";}
if($applicant_raw->typess==3){$branchme="BACOLOD";}
if($applicant_raw->typess==4){$branchme="CDO";}
if($applicant_raw->typess==5){$branchme="GENSAN";}
?>

<div class="col-sm-2">
<div class="form-group">
<label>Type</label>
<select name="applicant[basic][typess]" class="form-control" required onchange="showapplicant(this.value)">
<option value="<?php echo $applicant_raw->typess;?>"><?php echo $branchme; ?></option>
...
<div class="form-group">
<label>Source</label>
<select name="applicant[source]" class="form-control" id="showapp" required>
<option value="<?=$applicant['agent_id']?>"><?=$applicant['agent_first']?> <?=$applicant['agent_last']?> <?=$applicant['agent_id']?></option>
...
<span class="input-icon icon-right">
<div class="input-group">
<input name="applicant[basic][applicant_by_interview]" type="text" class="form-control"  value="<?php echo $applicant_raw->applicant_by_interview; ?>">
</div>
</span>
</div>
</div>
...
<a target='_blank'  href="http://iwebframework.com/globalpro/others/trainings.php?idme=<?=$applicant['applicant_id']?>&&user=<?=$_SESSION['admin']['user']['user_fullname']?>" 
style="font-size:18px;font-weight:bold;color:white;font-family:arial;background:red;padding:8px;border:1px solid black">Add Trainings </a> 
...
<a target='_blank'  href="http://iwebframework.com/globalpro/others/medical_history.php?idme=<?=$applicant['applicant_id']?>&&user=<?=$_SESSION['admin']['user']['user_fullname']?>" style="font-size:18px;font-weight:bold;color:#DC143C">Update Medical </a> 
<div style="clear:both;height:15px"></div>
...
<div class="row">
  ...
  <div class="col-sm-3"  style="font-size:14px;color:black">
<div class="form-group">
<label>Medical Type:</label>
<b style="font-size:13px"><?php echo $applicant_certificate_direct->medicaltype; ?></b>
</div>
</div>  
...
<b style="font-size:13px"><?php echo $applicant['certificate_medical_result']; ?></b>
</div>
</div>
...
<b style="font-size:13px"><?php echo $applicant['certificate_medical_remarks']; ?></b>
</div>
</div>
<div style="clear:both;height:5px"></div>
...
<b style="font-size:13px"><?php echo fdate( 'Y-m-d', $applicant['certificate_medical_exam_date'], '0000-00-00' ); ?></b>
</div>
</div>
...
<b style="font-size:13px"><?php echo $applicant_certificate_direct->medical_fit; ?></b>
</div>
</div>
...
<b style="font-size:13px"><?php echo $applicant_certificate_direct->certificate_medical_expiration; ?></b>
</div>
</div>
...
<select name="applicant[certificate][covidme]" class="form-control">
...
<input type="text" name="applicant[certificate][covid_name]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covid_name; ?>">
</div>
</div>
...
<input type="date" name="applicant[certificate][covid_date]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covid_date; ?>">
</div>
</div>
...
<input type="date" name="applicant[certificate][covid_date2]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covid_date2; ?>">
</div>
</div>
...
<input type="text" name="applicant[certificate][covid_loc]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covid_loc; ?>">
</div>
</div>
...
<div class="checkbox">
<label>
<input name="applicant[certificate][covid_yellow]" type="checkbox" class="inverted" <?php echo $applicant_requirements_direct->covid_yellow ? 'checked' : ''; ?>>
...
<div class="checkbox">
<label>
<input name="applicant[certificate][covid_cert]" type="checkbox" class="inverted" <?php echo $applicant_requirements_direct->covid_cert ? 'checked' : ''; ?>>
...
<div class="form-group">
<label>Booster</label>
<input type="text" name="applicant[certificate][covidb1]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covidb1; ?>">
</div>
</div>
...
<input type="text" name="applicant[certificate][covidb2]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covidb2; ?>">
</div>
</div>
...
<input type="Date" name="applicant[certificate][covidb3]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->covidb3; ?>">
</div>
</div>
...
<h4 style="margin-left:14px;color:white;font-size:14px;background:#4682B4;padding:5px;width:150px;text-align:center">Online Requirements</h4>

<div class="col-sm-2">
<div class="checkbox">
<label>
<input name="applicant[certificate][ereg]" type="checkbox" class="inverted" <?php echo $applicant_certificate_direct->certificate_ereg ? 'checked' : ''; ?>>
<span class="text"> E-REG</span>
</label>
</div>
</div>
...
<div class="checkbox">
<label>
<input name="applicant[certificate][peos]" type="checkbox" class="inverted" <?php echo $applicant_certificate_direct->certificate_peos ? 'checked' : ''; ?>>
<span class="text"> PEOS</span>
</label>
</div>
</div>
...
<input type="DAte" name="applicant[certificate][peosd]" class="form-control" placeholder="" value="<?php echo $applicant_certificate_direct->certificate_peosd	; ?>">
</div>
</div>
...
<input type="text" name="applicant[certificate][pagibig]" class="form-control" placeholder="" value="<?php echo $applicant_certificate_direct->pagibig	; ?>">
</div>
</div>


<div style="clear:both;height:5px"></div>
<h4 style="margin-left:14px;color:white;font-size:14px;background:#4682B4;padding:5px;width:150px;text-align:center">Certificates</h4>

<div class="col-sm-2">
<div class="checkbox">
<label>
<input name="applicant[certificate][tor]" type="checkbox" class="inverted" <?php echo $applicant_certificate_direct->certificate_tor ? 'checked' : ''; ?>>
<span class="text"> TOR/DIP</span>
</label>
</div>
</div>
...
<div class="checkbox">
<label>
<input name="applicant[certificate][prc_cert]" type="checkbox" class="inverted" <?php echo $applicant_certificate_direct->certificate_prc_cert ? 'checked' : ''; ?>>
<span class="text"> PRC CERTIFICATE</span>
</label>
</div>
</div>
...
<div class="checkbox">
<label>
<input name="applicant[certificate][bc]" type="checkbox" class="inverted" <?php echo $applicant_certificate_direct->certificate_bc ? 'checked' : ''; ?>>
...
<div class="checkbox">
<label>
<input name="applicant[certificate][mc]" type="checkbox" class="inverted" <?php echo $applicant_certificate_direct->certificate_mc ? 'checked' : ''; ?>>
<span class="text"> Marriage Contract</span>
</label>
</div>
</div>
...
<div class="col-sm-2 owwa-col" style="<?=$myhidedata?>">
...
<div class="col-sm-2 owwa-from-col" style="<?=$myhidedata?>">
<div class="form-group">
...
<div class="col-sm-2 owwa-to-col" style="<?=$myhidedata?>">
...
<h4 style="margin-left:14px;color:white;font-size:12px;background:#FF6347;padding:5px;width:150px;text-align:center">Visa/Calling Visa</h4>
<div class="row">
...
<div class="col-sm-2" style="">
<div class="form-group">
<label>BIOMETRICS/MIGRAMS</label>
...
<div class="col-sm-2" style="">
<div class="form-group">
<label>APPROVED MUSANED </label>
<input name="applicant[requirement][mol]" type="date" data-date-format="yyyy-mm-dd" class="form-control visa-date-expired" placeholder="yyyy-mm-dd"  value="<?php echo $applicant_requirements_direct->applicant_requirement_visaremarks	; ?>"    <?=$mystatus?>>
...
<div class="col-sm-2 visa-remarks-col" style="display:none" >
<div class="form-group">
...
<h4 style="margin-left:14px;color:white;font-size:14px;background:#4682B4;padding:5px;width:150px;text-align:center">Insurance</h4>
<div style="clear:both;height:1px"></div>
...
<input type="text" name="applicant[requirement][insurance1]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->insurance1	; ?>">
</div>
</div>
...
<input type="text" name="applicant[requirement][insurance2]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->insurance2	; ?>">
</div>
</div>
...
<input type="text" name="applicant[requirement][insurance3]" class="form-control" placeholder="" value="<?php echo $applicant_requirements_direct->insurance3	; ?>">
</div>
</div>
<div style="clear:both;height:1px"></div>


<h4 style="margin-left:14px;color:white;font-size:14px;background:#4682B4;padding:5px;width:170px;text-align:center">Contracts</h4>
...
<div class="col-sm-2">
<div class="form-group">
<a target='_blank'  href="http://iwebframework.com/globalpro/others/sponsor.php?idme=<?=$applicant['applicant_id']?>&&user=<?=$_SESSION['admin']['user']['user_fullname']?>" style="font-size:18px;font-weight:bold;color:#DC143C;display:none">Add 2nd ,3rd Sponsor </a> 
</div>
</div>
...
<option>Waiting for Calling Visa</option>
<option>For Contract Signing</option>
