                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <label for="employer[contact]" style="color:orange">Selection Process</label>

                            <input name="employer[selections]" type="number" placeholder="Selection Process PUT number of DAYS" class="form-control" value="<?php echo $employer['employer_selections']; ?>">
                        ...
                        <div class="form-group"  style="display:none">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" style="border-left:1px dashed #999" style="display:none">
                        ...
                        <div class="form-group"> 
                            ...
                            <label for="employer[remarks]">Agreement Details</label>

                            <textarea name="employer[remarks]" rows="5" placeholder="Agreement Details" class="form-control"><?php echo $employer['employer_remarks']; ?></textarea>
