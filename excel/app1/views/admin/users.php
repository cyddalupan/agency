...
<?php
if($user['branch_id']==1){$branchme="MAIN";}
if($user['branch_id']==2){$branchme="ILOILO";}
if($user['branch_id']==3){$branchme="BACOLOD";}
if($user['branch_id']==4){$branchme="CDO";}
if($user['branch_id']==5){$branchme="GENSAN";}
if($user['branch_id']==0){$branchme="";}
?>
...
<?php echo $branchme; ?>
                                    ...
                                    <td class="numeric">
                                        <a href="#" role="button" class="btn btn-xs btn-default btn-settings cyd_save_user_id" data-toggle="modal" data-target="#modalSettings" data-user="<?php echo $user['user_id']; ?>"><i class="fa fa-gear"></i> Settings</a>
										 <a href="http://iwebframework.com/globalpro/others/users.php?ume=<?php echo $user['user_id']; ?>" role="button" class="btn btn-xs btn-default"  data-user="<?php echo $user['user_id']; ?>" target="_blank"><i class="fa fa-gear"></i> Assign</a>
