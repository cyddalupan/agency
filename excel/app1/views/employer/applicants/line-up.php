		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-3 col-xs-4" style="height:520px;border:0px solid black">
				<div class="result-item">
                    ...
                    <div class="well">
						<p>Date Lineup: <?php echo date( 'd-M-Y', strtotime( $applicant['applicant_updated'] ) ); ?></p>
                        <p>Age: <?php echo (int) $applicant['applicant_age']; ?></p>
                        <p>Status: <?php echo $applicant['applicant_civil_status']; ?></p>
						<p>Medical Status: <?php echo $applicant['certificate_medical_result']; ?></p>
						<p>Medical Expiry: <?php echo $applicant['certificate_medical_expiration']; ?></p>
						 <p><strong><?php echo $applicants_raw[$applicant['applicant_id']]->applicant_ex; ?></strong></p>
                    </div>
