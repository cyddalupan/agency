...
<form id="demo-form2" method="post" action="https://workasia.agency/system/employer/dashboard">

<div class="input-group">
  <div class="form-outline">
    
	<input type="text" placeholder="last name " class="form-control" name="mydata" required>

    <label class="form-label" for="form1" STYLE="COLOR:BLACK;FONT-SIZE:">Search Applicant LAST NAME</label>
  </div>
...
if(isset($_POST['Search1']))
{
	...
	and applicant_last LIKE '%".$_POST['mydata']."%'
