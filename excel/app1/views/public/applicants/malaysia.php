...
<DIV style="border:1px solid black;margin-top:-20pt">
...
<div style="float: right; width: 20%; margin-top:0px;height:130px	0px;border:0px solid red;margin-left:-15px;padding:10px;background:#F0F0F0 ;">
				<img src="{profile_picture}" style="float:right; height:160px;width:100% " />
</div>
...
<!--half BOX-->
<div class="" style="float: left; width: 60%;min-height:100px;height:!important ">
		<!--STATIC DATA-->
		<div class="blue" style="float: left;">
...
<div style="FONT-SIZE:16PX;color:White;float: left;TEXT-align:center">PERSONAL ABILITIES
		<P style="margin-top:-3px">State household duties that you can perform very efficiently</P></div>
	</div>
	<div class="" style="float: left;BORDER:0PX Solid black;HEIGHT:50PX;PADDING:10PX">
			<div STyle="clear:both;HEIGHT:10PX"></div>			
			<div style="FONT-SIZE:13PX;float: left;width:100%"><b>{applicant_remarks5}</b></div>	
	</div>
...
<DIV style="border:1px solid black;">	
	...
	<div class="" style="float: left;BORDER:0PX Solid black;HEIGHT:50PX;PADDING:10PX">
			<div STyle="clear:both;HEIGHT:10PX"></div>			
			<div style="FONT-SIZE:13PX;float: left;width:100%"><b>{applicant_remarks6}</b></div>	
	</div>
...
<p>	I <U>{applicant_name}</U> hereby confirms that the information on this form is, to the
 best of my knowledge , true  and complete . I acknowledge that I have
not with held any materials information which  might preclude me from working overseas. 
I shall abide by the rules and regulations of <b>Work Asia International Recruitment Agency Inc,</b> and work conditions	of my future Employer. I wish to testify tha I want to go and work overseas as Domestic Helper . I further affirm that I shall, to the best of my abilities to complete my Two (2) years contract of my Employment.	<p></div>	
</div>
