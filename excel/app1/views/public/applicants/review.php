...
<input type="text" name="applicant[education][others]" class="form-control" placeholder="yyyy" value="<?php echo isset( $post['applicant']['education']['others'] ) ? $post['applicant']['education']['others'] : $applicant['education_others']; ?>">
