...
<div class="" style="margin-bottom: 12pt;border:2px solid black ">
<h3>PERSONAL DATA</h3>
    <table cellspacing="0" cellpadding="1">
        <tr>
            <th style="text-align:center;width:300px;border:none">Full Name : {applicant_name}</th>
			 <th style="text-align:center;border:none">Contact # : {contact}</th>
		</tr>
...
<div class="" style="float:left; width: 43%; margin-bottom: 2pt; padding:0px; ">
    <div>
        <table cellspacing="0" cellpadding="1">
            <tr >
...
<div class="" style="float:right; width: 52%; margin-left:10px; margin-bottom: 2pt; ">
    <div>
