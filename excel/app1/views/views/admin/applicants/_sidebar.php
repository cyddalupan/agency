...
<div class="page-sidebar <?php echo $app->getSideBarClass(); ?>" id="sidebar">
    ...
    <div class="sidebar-header-wrapper">
        ...
        <input type="text" name="keyword" class="searchinput"  required/>
        </form>
    ...
    <ul class="nav sidebar-menu">
		...
		<i class="menu-icon fa fa-globe"></i>
		 ...
		 <li>
			...
			<li>
            <a  href="http://fil-gulf.com/cases" target="_blank" title="New Media">
								<i class="menu-icon fa fa-folder-o"></i>
                <span class="menu-text" style="color:blue">Cases<span ng-show="{{notifmedia}}" class="badge bg-danger"></span></span>
            </a>
        </li>
		
		<li>
            <a  href="http://fil-gulf.com/system/others/passporting.php?id=15" target="_blank" title="New Media">
								<i class="menu-icon fa fa-folder-o"></i>
                <span class="menu-text" style="color:Red">New Process<span ng-show="{{notifmedia}}" class="badge bg-danger"></span></span>
            </a>
        </li>
