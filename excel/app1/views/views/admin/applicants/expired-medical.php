...
<div class="page-breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li>Applicants</li>
        <li class="active">Expired Medical</li>
    </ul>
</div>
<!-- /Page Breadcrumb -->
<!-- Page Header -->
<div class="page-header position-relative">
    <div class="header-title">
        <h1>
            Applicants with Expired Medical
        </h1>
    </div>
    <!--Header Buttons-->
                        ...
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="numeric">
                                        <?php echo $applicant['certificate_medical_clinic']; ?>
                                    </td>
                                    <td >
                                        <?php echo date( 'd-M-Y', strtotime( $applicant['certificate_medical_exam_date'] ) ); ?>
                                    </td>
                                    <td>
                                    ...
                                    <td class="numeric danger">
                                        <?php echo date( 'd M Y', strtotime( $applicant['certificate_medical_expiration'] ) ); ?>
                                    </td>
                                </tr>
                                <?php $ctr++; ?>
                                <?php endforeach; ?>
