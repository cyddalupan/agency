        ...
        <div id="content">
        	<table id="applicants">
            	<tbody>
                    ...
                    <?php if ( count( $agency['employers'] ) == 0) continue; ?>
                    <tr>
                        <td colspan="6" style="text-align:left; ">
                            Agency: <strong><span style="text-transform:uppercase; color:blue"><?php echo $agency['agency_name']; ?></span></strong>
                        </td>
                    </tr>
                    <tr>
                        <th width="1%">#</th>
                    ...
                    <?php foreach ( $agency['employers'] as $employer ): ?>
                    <?php $ctr ++; ?>
                    <tr>
                    	<td><?php echo $ctr; ?></td>
