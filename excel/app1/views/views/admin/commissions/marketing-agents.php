                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-applicants">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo site_url( 'admin/commissions/marketing-agent-all/'.$agent['agent_id'] . $queryString); ?>" >
                                        <strong><?php echo $agent['agent_first'].' '.$agent['agent_last'] ?></strong>
                                        </a>
                                    </td>
                                    <td><?php echo $agent['agent_contacts']; ?></td>
                                    <td>
                                        &#8369;&nbsp;<span class="text-default"><?php echo number_format( $agent['total_commission'], 2 ); ?></span>
                                    </td>
                                    <td>
                                        &#8369;&nbsp;<span class="text-danger"><?php echo number_format( $agent['remaining'], 2 ); ?></span>
                                    </td>
                                    <td>
                                        &#8369;&nbsp;<span class="text-info"><?php echo number_format( $agent['total_paid'], 2 ); ?></span>
                                    </td>
                                    <td>
                                    	<a href="<?php echo site_url( 'admin/commissions/marketing-agent-all/'.$agent['agent_id'] ); ?>" class="btn btn-xs btn-default">Open</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
