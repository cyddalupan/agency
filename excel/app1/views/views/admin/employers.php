                        ...
                        <table class="table table-bordered table-hover table-applicants">
                            <thead class="bordered-palegreen">
                                <tr>
                                    ...
                                    <th>Employer / Agency name</th>
                                    <th>Email</th>
                                    <th>Contact person</th>
                                    <th>Contact</th>
                                    <th>Country</th>
                                    <th>Source (Marketing Agency)</th>
                                    <th>Source (Marketing Agent)</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-transform:uppercase">
                                        <abbr title="<?php echo $employer['employer_name']; ?>"><?php echo $employer['employer_no']; ?></abbr>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php echo $employer['agency_name']; ?>
                                    </td>
                                    <td>
                                        <?php echo $employer['agent_first'].' '.$employer['agent_last']; ?>
                                    </td>
                                    <td>
