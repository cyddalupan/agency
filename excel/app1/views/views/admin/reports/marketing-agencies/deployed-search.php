...
<div class="modal-header">
    ...
    <h4 class="modal-title">Deployed Applicants</h4>
</div>

<form method="post" class="form" action="<?php echo site_url( 'admin/reports/marketing-agencies-deployed-applicants' ); ?>" target="_blank">
<div class="modal-body">
    <div class="bootbox-body">
    	...
    	<div class="row">			
			...
			<div class="col-sm-5">
				<select name="applicant[agency]" class="form-control">
