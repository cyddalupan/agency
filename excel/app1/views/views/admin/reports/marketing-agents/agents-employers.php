        ...
        <div id="content">
        	<table id="applicants">
            	<tbody>
                    ...
                    <?php if ( count( $agent['employers'] ) == 0) continue; ?>
                    <tr>
                        <td colspan="6" style="text-align:left; ">
                            Agent: <strong><span style="text-transform:uppercase; color:blue"><?php echo $agent['agent_first'].' '.$agent['agent_last']; ?></span></strong>
                        </td>
                    </tr>
                    <tr>
                        <th width="1%">#</th>
