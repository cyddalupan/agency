...
<input type="text" id="app_fb" name="app_fb" value="<?=$row['app_fb']?>" >
		...
		<td><a href="<?=$row['app_fb_link']?>" target="_blank"><?=$row['app_fb_link']?></a>	<td>
</tr>
...
<tr>
	...
	<td> <label for="fname"> Person in Charge</label>
...
<tr>
		<td COLSPAN=""><label for="fname">ADDRESS</label>
...
<div style="clea:both"></div>
<textarea name="app_remarks1" style="width:280px;height:70px;:border:2px solid red;" required><?=$row['app_remarks1']?></textarea>
