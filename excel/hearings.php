...
<ul>
 ...
 <p style="font-size:16px"> 
					    <a href="add.php?idme=<?=$row["SUBJ_ID"]?>"   onclick="basicPopup(this.href);return false"><button style="background:Red">ADD NEW</button></a> 
                    </p>
...
<div class="blink"><span>Schedule. . . </span></div>
	<iframe src="https://manpowerportalph.com/portal2/excel/index2.php" style="width:100%;margin:auto 0 ;height:1000px"></iframe>
...
<table class="js-sort-table" style="width:110%;margin-left:10px" id="myTable">
<thead>
<tr>
<th></th>
<th></th>
...
<?php
$SQLSELECT = "SELECT * FROM  hearings  
LEFT JOIN subject
...
?>
<td> 
<a href="hearingedit.php?idme=<?=$row["happ"]?>" onclick="basicPopup(this.href);return false"><button>Hearings</button></a> 
</td>
<td> 
<a href="update.php?idme=<?=$row["happ"]?>"   onclick="basicPopup(this.href);return false"><button style="background:Red">Complaint</button></a> 
</td>
