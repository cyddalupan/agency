...
<h1 style="text-align:center"> Deployed </h1>
...
<th style="width:6%">Deployed Date</th>
...
<?php
$count=1;
$fit =mysql_query("SELECT applicant.applicant_id as adonis,deployed.*,
applicant.*
FROM deployed
LEFT JOIN applicant
...
echo'<td>'; echo date('M-d-Y', strtotime($row['deployed_date']));echo'</td>';
