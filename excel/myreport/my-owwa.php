...
<h1 style="text-align:center"> OWWA 1st</h1>
...
where  certificate_owwa_from NOT IN ('1970-01-01','0000-00-00','')

AND certificate_owwa_from='".$_GET["dateme"]."'  group by applicant_id");
