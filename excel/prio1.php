		...
		* {
		...
		<a class="brand" href="#">Welfare MANAGEMENT</a>
		...
		<li><a class="active" href="prio.php">Complaint</a></li>
		...
		<H2>'CLOSED Complaint'</H2>
		<a href="prio.php" style="font-size:16px;font-weight:bold;color:Red;margin;20px">ACTIVE</a> | 
		<a href="prio1.php"  style="font-size:16px;font-weight:bold;color:green;margin;20px">CLOSED</a>
	
		<table class="table table-bordered" style="width:110%;margin-left:10px" id="myTable">
		<thead>
		<tr>
		<th>ID</th>
		<th></th>		  	    
		...
		where  app_status1  IN ('CLOSED') order by SUBJ_ID desc ";
		...
		LEFT JOIN recruitment_agent
		ON subject.agent_id = recruitment_agent.agent_id
		where  fra_name='".$_POST['fra']."' and  app_status1  IN ('CLOSED') order by SUBJ_ID desc ";
		...
		where  app_country='".$_POST['country']."'  app_status1  IN ('CLOSED') order by SUBJ_ID desc ";
...
$color21a="black";
	  ...
	  <?php echo'<tr style="background:'.$color111a.';color:'.$color21.'">'; ?>
		<td><?php echo $count; ?></td>
	               ...
	               <td> 
                    <a href="edit.php?idme=<?=$row["SUBJ_ID"]?>" onclick="basicPopup(this.href);return false"><button>owms</button></a> 
                    </td>
                     <td> 
