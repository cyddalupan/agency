...
<div class="navbar bs-docs-nav" role="banner">
	<div class="container">
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown <?php echo subControllerActive('applicants/available'); ?>">

				<a href="<?php echo site_url( 'employer/applicants/available' ); ?>" >Available</a>
			...
			<li class="dropdown <?php echo subControllerActive('applicants/line-up'); ?>">
				...
				<a href="<?php echo site_url( 'employer/applicants/line-up' ); ?>" >Interview</a>

			</li>
			
			<li class="dropdown employer-reserved-menu <?php echo subControllerActive('applicants/reserved'); ?>">
				<a href="<?php echo site_url( 'employer/applicants/reserved' ); ?>" >Hired</a>
			</li>
			
			<!-- <li class="dropdown employer-pre-selected-menu">
			...
			<li class="dropdown <?php echo subControllerActive('applicants/selected'); ?>">
				<a href="<?php echo site_url( 'employer/applicants/selected' ); ?>" >On process</a>
			</li>
			<li class="dropdown">
