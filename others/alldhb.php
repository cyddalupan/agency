...
<li><a  class="active" href="view_branch.php?imy=<?=$_GET['imy']?>&&user=<?=$_GET['user']?>">All </a></li>
<li><a   href="passporting1.php?imy=<?=$_GET['imy']?>&&user=<?=$_GET['user']?>">Passporting </a></li>
<li><a   href="alldhb.php?imy=<?=$_GET['imy']?>&&user=<?=$_GET['user']?>">All Household </a></li>
<li><a   href="allskilledb.php?imy=<?=$_GET['imy']?>&&user=<?=$_GET['user']?>">All Skilled</a></li>
<li><a  href="view_coordinator11.php?imy=<?=$_GET['imy']?>&&user=<?=$_GET['user']?>">In Process </a></li>
<li><a   href="view_coordinator22.php?imy=<?=$_GET['imy']?>&&user=<?=$_GET['user']?>">Cancelled </a></li>
</ul>
<h3><span>All Household</span></h3>
...
$agent88 = mysql_query("SELECT * FROM  recruitment_agent where agent_id=".$row['applicant_source']." ");
