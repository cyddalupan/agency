...
<h3 style="color:black"><span>NO VACCINE</span></h3>
<!-- para -->
...
where applicant_status  NOT IN (9,21,22,1,14)
and covidme IN ('No Vaccine','1st Dose','')
...
echo'<td>'.$row["employer_name"].'</td>';
 echo"<td>".$row['covid_name']."</td>";
 
 IF($row['covid_date']=='1970-01-01' || $row['covid_date']=='0000-00-00' ) { echo"<td></td>"; }
else{ echo"<td>".$row['covid_date']."</td>"; }
