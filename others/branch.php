...
where
applicant_status NOT IN (9,21,22,1,14)
and applicant_source=".$_GET['branch']."
...
<h3><span> Process Applicants</span></h3>
<!-- para -->
</br>
<a href="branch.php?branch=<?=$_GET['branch']?>" style="background:green;padding:4px;color:white">Process</a> | 	
<a href="branchd.php?branch=<?=$_GET['branch']?>" style="background:#1E90FF;padding:4px;color:white">Deployed</a> |
<a href="branchc.php?branch=<?=$_GET['branch']?>" style="background:red;padding:4px;color:white">Unfiy/Cancelled</a> 
<br><br>
...
if($row['applicant_status']=='0') {$color='gray';}
...
echo"<td><a target='_blank'  href='http://fil-gulf.com/system/admin/applicants/review_single/".$row['applicant_id']."'>
...
echo"<td ><input type='date' value='".$row1['certificate_tesda_date']."' name='certificate_tesda_date[]' style='background:green'><i style='font-size:1px'>".$row1['certificate_tesda_date']."<i></td>";
}
...
echo"<td><input type='date' value='".$row1['certificate_pdos_date']."' name='certificate_pdos_date[]'><i style='font-size:1px'>".$row1['certificate_pdos_date']."<i></td>";
}
else{ 
echo"<td ><input type='date' value='".$row1['certificate_pdos_date']."' name='certificate_pdos_date[]' style='background:green'><i style='font-size:1px'>".$row1['certificate_pdos_date']."<i></td>";
}
...
echo"<td ><input type='date' value='".$row2['requirement_visa_stamp']."' name='requirement_visa_stamp[]' style='background:green'><i style='font-size:1px'>".$row2['requirement_visa_stamp']."<i></td>";
}
...
echo"<td ><input type='date' value='".$row2['requirement_contract']."' name='requirement_contract[]' style='background:green'><i style='font-size:1px'>".$row2['requirement_contract']."<i></td>";
}
...
echo"<td ><input type='date' value='".$row2['requirement_contract_sign']."' name='requirement_contract_sign[]' style='background:green'><i style='font-size:1px'>".$row2['requirement_contract_sign']."<i></td>";
}
...
echo"<td ><input type='date' value='".$row1['certificate_owwa_to']."' name='certificate_owwa_to[]' style='background:green'><i style='font-size:1px'>".$row1['certificate_owwa_to']."<i></td>";
}
...
echo"<td ><input type='date' value='".$row2['requirement_oec_release_date']."' name='requirement_oec_release_date[]' style='background:green'><i style='font-size:1px'>".$row2['requirement_oec_release_date']."<i></td>";
}
...
echo"<td ><input type='text' value='".$row2['requirement_exp']."' name='requirement_exp[]' style='background:none'><i style='font-size:1px'>".$row2['requirement_exp']."<i></td>";
