...
<th style="font-size:10px">OEC</th>	
	...
	<th style="font-size:10px">FLIGHT</th>										
...
if($row['applicant_status']=='9') {$color='red';}
...
echo"<td style='color:black;'>".$row1['certificate_medical_expiration']."</td>";
}
if ($row1['certificate_medical_expiration'] > $datenow) {
...
echo"<td><input type='date' value='".$row2['flight_date']."' name='flight_date[]'><i style='font-size:1px'>".$row2['flight_date']."<i></td>";
}
else{ 
echo"<td ><input type='date' value='".$row2['flight_date']."' name='flight_date[]' style='background:green'><i style='font-size:1px'>".$row2['flight_date']."<i></td>";
}
