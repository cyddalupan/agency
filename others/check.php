...
<div class="gradient" style="float: right; margin-bottom: 0pt;width: 25% ">
    <img src="https://recruitment-ph.com//skyhigh/files/applicant/<?=$info['applicant_photo']?>" style="float:right; height:210px;BORDER:1PX SOLID BLACK;width:250px;margin-top:-100px "  />
</div>
...
?>
 ...
 <img src="https://recruitment-ph.com/skyhigh/<?=$files1['file_path']?>" style="width:85%;margin:30px"  />
