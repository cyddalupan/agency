...
<h2 style="color:black"> <b style="color:red">FRA</b></h2>
...
$totalmew=$fitt['alls']+$onselected1['alls']+$onprocess1['alls'];
$totalsaudi=$totalmew+$deployedw['alls'];


echo'<td>0'.$row["employer_id"].'</td>';
echo'<td style="text-align:left"><b>'.$row["employer_name"].'</b></td>';
echo'<td style="text-align:center;color:black;background:#C0C0C0"><a href="#">'.$totalmew.'</a></td>';
...
echo'<td  style="text-align:center;color:black;background:#90EE90"><a href="myreport/notsigned.php?empname='.$row["employer_name"].'&&empid='.$row["employer_id"].'">'.$contractsign1['alls'].'</a></td>';
...
<tr>
<td colspan="3" style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total </td>
<td  style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$totalmew1?></td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$fitall?></td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$onselected12?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$onprocessall?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$signall?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$contractsignsaudi?></td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$owwasaudi?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$visaall?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$oecall?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$ticketsaudi?></td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$ticketwithsaudi?> </td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$rebook2?> </td>




<td  style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=number_format($percentall,1)?>%</td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD">  <?=$deployedall?></td>
<td style="text-align:center ;color:white;font-weight:bold;font-size:18px;background:#0000CD"> <?=$totalsaudi1?></td>
</tr>
</table>
