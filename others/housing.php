...
<h3><span> Hired Applicants</span>  </br><small style="text-align:right"><a id="downloadLink" onclick="exportF(this)" style="color:Red;font-size:11px">Export to excel</a>
</small></h3>
<!-- para -->
...
<th style="font-size:12px">Date Hired</th>
<th style="font-size:12px">School District</th>
<th style="font-size:12px">Visa Sponsor</th>
<th style="font-size:12px">Housing Arrangement</th>
<th style="font-size:12px">Family Name</th>
<th style="font-size:12px"># Of Bedroom</th>
<th style="font-size:12px">Sharing</th>
...
echo"<td>".$row2['apartment']."</td>";
echo"<td>".$row2['a_bedroom']."</td>";
echo"<td>".$row2['a_sharing']."</td>";
