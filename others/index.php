...
$flightrowdate .="{
    title: 'TESDA 1ST (".$tesdatoday['fefe'].")',
...
//OWWA 2nd Release
$owwa2nd = "SELECT 
count(certificate_owwa_to) as fefe,
applicant.applicant_id as adonis, applicant_certificate.*,applicant.* FROM applicant
LEFT JOIN 	applicant_certificate
ON applicant.applicant_id=applicant_certificate.certificate_applicant
where  certificate_owwa_to NOT IN ('1970-01-01','0000-00-00','') GROUP BY certificate_owwa_to";
$owwa2nd1 = $conn->query($owwa2nd);
while($owwa2nd22 = $owwa2nd1->fetch_assoc() ){

$flightrowdate .="{
    title: 'OWWA 2nd (".$owwa2nd22['fefe'].")',
    url: 'myreport/my-owwa2nd.php?dateme=".$owwa2nd22['certificate_owwa_to']."',
    start: '".$owwa2nd22['certificate_owwa_to']."'
    },";
}


//Tesda 2ND
$tesdar2nd = "SELECT count(certificate_tesda_release) as fefe, applicant_certificate.* FROM applicant_certificate 
WHERE  certificate_tesda_release  NOT IN ('1970-01-01','0000-00-00','')
group by certificate_tesda_release ";
$tesdar2nd2= $conn->query($tesdar2nd);
while($tesdar2nd22 = $tesdar2nd2->fetch_assoc() ){

$flightrowdate .="{
    title: 'TESDA 2nd (".$tesdar2nd22['fefe'].")',
    url: 'myreport/my-tesda2nd.php?dateme=".$tesdar2nd22['certificate_tesda_release']."',
    start: '".$tesdar2nd22['certificate_tesda_release']."'
    },";
}

//swab 2ND
$swab = "SELECT count(swab_date) as fefe, applicant_certificate.* FROM applicant_certificate 
WHERE  swab_date  NOT IN ('1970-01-01','0000-00-00','')
group by swab_date ";
...
$flightrowdate .="{
    ...
    url: 'myreport/my-swab.php?dateme=".$swab2['swab_date']."',
...
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #FFD700;TEXT-ALIGN:center"> MEDICAL</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #B0E0E6;TEXT-ALIGN:center"> TESDA 1ST</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #B0E0E6;TEXT-ALIGN:center"> TESDA 2ND</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #FFB6C1;TEXT-ALIGN:center"> OWWA 1st</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #FFB6C1;TEXT-ALIGN:center"> OWWA 2nd</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #87CEFA;TEXT-ALIGN:center"> VFS</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #FFEFD5;TEXT-ALIGN:center"> OEC</div>
<div style="float:right;width:120px;border:1px solid black;padding:2px; background-color: #98FB98;TEXT-ALIGN:center"> FLIGHTS</div>
