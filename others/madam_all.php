...
<li><a  class="active"  href="madam_all.php">All Applicant </a></li>
...
<table class="table table-hover table-striped table-bordered"  id="example-checkbox" STYLE="FONT-SIZE:12px;width:65%" >
<thead>
<tr>
...
IF($row['passport_expiration']=='1970-01-01' || $row['passport_expiration']=='0000-00-00' ) { echo"<td></td>"; }
else{ echo"<td>".$row['passport_expiration']."</td>"; }
...
if($row1['certificate_tesda']=="0"){echo"<td></td>";}
if($row1['certificate_tesda']!="0"){echo"<td>".$row1['certificate_tesda']."</td>";}
