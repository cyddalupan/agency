...
where
applicant_status  IN (21,22,1,14,25)
...
<li><a   class="active"  href="madam_cancelled.php">Cancelled</a></li>
...
<th style="font-size:10px">Expiration</th>
<th  style="font-size:10px;background:lightgray">CV Sent </th>	
...
<th style="font-size:10px">Contract SIGNED</th>	
...
echo"<td style='color:black;background:red'></td>";
}
if ($row1['certificate_medical_expiration'] > $datenow) {
...
echo"<td>";
echo "" .$lineup['log_created'];echo"</td>";
