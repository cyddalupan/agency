...
<a href="med.php?medical=5"  STYLE="background:#191970;padding:10px;color:white;font-size:16px;margin:5px">FOR MEDICAL</a> |
<a href="med.php?medical=1" STYLE="background:#191970;padding:10px;color:white;font-size:16px;margin:5px">FIT TO WORK</a> | 
<a href="med.php?medical=2"  STYLE="background:red;padding:10px;color:white;font-size:16px;margin:5px">PEDING</a> | 
<a href="med.php?medical=3"  STYLE="background:red;padding:10px;color:white;font-size:16px;margin:5px">UNFIT</a> | 
<a href="med.php?medical=6"  STYLE="background:red;padding:10px;color:white;font-size:16px;margin:5px">BACKOUT</a> |
<a href="med.php?medical=4"  STYLE="background:red;padding:10px;color:white;font-size:16px;margin:5px"><b>NO UPDATE</b></a> 
...
style="border:3px solid black;padding:5px;color:white;margin:10px;FONT-size:16px;position:absolute;float:left;BACKGROUND:GREEN;margin-left:500px">MULTIPLE LINE UP</a>
