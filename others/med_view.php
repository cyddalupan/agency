...
<table class="table table-hover table-striped table-bordered"  id="example-checkbox" style="width:110%;font-size:14px" >
<thead>
<tr>
...
<th>Result</th>
<th>-Date Expired</th>	
<th>Remarks <SMALL STYLE="font-size:9px">when to GO BACK</SMALL></th>
<th>Status</th>
<th>-Remarks</th>				
</tr>
</thead>
...
if($row['certificate_medical_result']==''){
echo"<td STYLE='color:black;font-size:9px'>NO RESULT MEDICAL</td>";
}
...
<input type='TEXT'  name='certificate_medical_remarks[]' value='".$row['certificate_medical_remarks']."' style='width:120px'></td>";
