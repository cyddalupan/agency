...
if($_POST['status_medical']!='99999'){
$medicalstatus="certificate_medical_result='".$_POST['status_medical']."' AND ";		
...
where
certificate_medical_exam_date between '".$_POST['start']."' AND '".$_POST['end']."'
$medicalstatus 
...
echo"<td>".$row['certificate_goback']."</td>";
