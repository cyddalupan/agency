...
<h1 style="text-align:center"> BIOMETRICS Schedule  </h1>
...
where 
applicant_employer IN (".$employerr.")
AND vfs NOT IN ('1970-01-01','0000-00-00','')
AND vfs='".$_GET["dateme"]."'  group by applicant_id");
