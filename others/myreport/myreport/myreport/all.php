...
<h1 style="text-align:center"> Total Applicants </h1>
...
where      applicant_status    NOT IN (21,22,1,14,25,5)
...
echo'<td>'; echo date('M-d-Y', strtotime($row['applicant_updated']));echo'</td>';
