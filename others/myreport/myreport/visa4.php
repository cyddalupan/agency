...
<h1 style="text-align:center"> Visa Stamped</h1>
...
where stamped_kuw  NOT  IN ('1970-01-01','0000-00-00','')
AND applicant_status    NOT IN (9,21,22,1,14,25,5)
AND applicant_employer=".$_GET["empid"]." group by applicant_id order by status asc");
...
IF($row['stamped_kuw']=='1970-01-01' || $row['stamped_kuw']=='0000-00-00' ) { echo"<td></td>"; }
else{  echo'<td>'; echo date('M-d-Y', strtotime($row['stamped_kuw']));echo'</td>'; }
