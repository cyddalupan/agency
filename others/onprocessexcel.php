...
$stt="applicant_status NOT IN (99)";
$titi='ALL ';	
}
...
$stt="applicant_status   NOT IN (9,21,22,1,14,25)";
$titi='GENERAL REPORTS';		
}
...
//$stt="applicant_status IN (1,14,25)";
//$titi='waiting oec';		
//}
if($_POST['status_app']=='32'){
...
if($_POST['employer']=='99999'){
	...
	$employer="applicant_employer IN(".implode(",",$nameArray).") AND";	
}
