...
<h1 STYLE="COLOR:BLACK"><span>OWWA </span></h1>
<!-- para -->

<?php
include'db.php';
include'functions_owwa.php';
...
<li><a    class="active" href="owwanew.php"><?=$owwa?></a></li>
...
<th STYLE="WIDTH:180px">FRA</th>
<th STYLE="WIDTH:180px">SPONSOR</th>
<th STYLE="WIDTH:120px">PDOS Date</th>
<th STYLE="WIDTH:120px">Date Filing</th>
<th STYLE="WIDTH:180px">Schedule of Training</th>	
...
IF($row1['certificate_pdos_date']=='1970-01-01' || $row1['certificate_pdos_date']=='0000-00-00' ||  $row1['certificate_pdos_date']=='0001-01-01' || $row1['certificate_pdos_date']=='' ) {
echo"<td></td>";
}else{  echo'<td>'; echo date('M-d-Y', strtotime($row1['certificate_pdos_date']));echo'</td>'; }


IF($row1['certificate_owwa_file']=='1970-01-01' || $row1['certificate_owwa_file']=='0000-00-00' ||  $row1['certificate_owwa_file']=='0001-01-01' || $row1['certificate_owwa_file']=='' ) {
echo"<td></td>";
}else{  echo'<td>'; echo date('M-d-Y', strtotime($row1['certificate_owwa_file']));echo'</td>'; }

IF($row1['certificate_owwa_from']=='1970-01-01' || $row1['certificate_owwa_from']=='0000-00-00' ||  $row1['certificate_owwa_from']=='0001-01-01' || $row1['certificate_owwa_from']=='' ) {
echo"<td></td>";
}else{  echo'<td>'; echo date('M-d-Y', strtotime($row1['certificate_owwa_from']));echo'</td>'; }

echo"<td><input type='hidden' name='applicant_id[]' value='".$row['applicant_id']."' checked>
<input type='TEXT'  name='certificate_owwaremarks[]' value='".$row1['certificate_owwaremarks']."'></td>";
