...
<h3 style="color:black"><span>Available / Pre Household</span></h3>
<!-- para -->
<?php include'menu.php';?>
<ul id="menu">
<li><a   href="dashboard.php">Dashboard</a></li>
<li><a href="preselected.php"  class="active"> Pre Applicants/Available</a></li>
...
<input name="mydate" type="date" data-date-format="yyyy-mm-dd" class="form-control date-picker" placeholder="To" required >
...
,applicant_updated= '".$_POST['mydate']."'
...
VALUES (".$delall." ,".$_POST['emp_id']." ,'".$_POST['mydate']."','".$_POST['mydate']."' )");

$app22 = mysql_query("INSERT INTO multiple_lineups1 (applicant_id,applicant_employer, created_at,updated_at)
VALUES (".$delall." ,".$_POST['emp_id']." ,'".$_POST['mydate']."','".$_POST['mydate']."' )");
