...
<h3><span> In Process Applicants</span>  </br><small style="text-align:right"><a id="downloadLink" onclick="exportF(this)" style="color:Red;font-size:11px">Export to excel</a>
</small></h3>
<!-- para -->
...
<th style="font-size:10px">Date Hired</th>
<th style="font-size:10px">School District</th>
<th style="font-size:10px">Visa Sponsor</th>
<th style="font-size:10px">Signed FCEC MOA</th>
<th style="font-size:10px">Signed FEE Schedule</th>
<th style="font-size:10px">Date Process</th>
<th style="font-size:10px">School Placement</th>
<th style="font-size:10px">Issue Document Checklist</th>
<th style="font-size:10px">Completed Requirements</th>
<th style="font-size:10px">Program Fees</th>
<th style="font-size:10px">Embassy Interview date</th>

<th style="font-size:10px">Housing Arrangement</th>
<th style="font-size:10px;width:300px">Remarks</th>	
...
$job = mysql_query("SELECT * FROM set_ where set_id=".$row2['dv']." ");
$job1=mysql_fetch_array($job);
