...
include'db.php';
if ($_GET['exp']==1){
$pass =  mysql_query("SELECT * from medical
LEFT JOIN email_address2
ON medical.app_id=email_address2.app_id 

LEFT JOIN recruitment_agent
ON email_address2.agent_id=recruitment_agent.agent_id 

where 
medical.med_expired NOT IN('0000-00-00','1970-01-01')
AND medical.med_expired <= DATE_ADD(DATE(now()), INTERVAL 14 day)
");
$visa="Expired Medical APPLICANTS";
}
...
<td style="color:green"><?=$row['med_expired']?></td>
