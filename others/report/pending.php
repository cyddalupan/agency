...
where 
applicant_certificate.certificate_medical_result='UNFIT'");
...
");
$visa="PENDING MEDICAL APPLICANTS";
}


if ($_GET['exp']==4){
$pass =  mysql_query("SELECT 
 applicant_certificate.*,applicant_requirement.*,applicant.*,employer.* FROM applicant
LEFT JOIN applicant_certificate
ON applicant.applicant_id=applicant_certificate.certificate_applicant
...
<td><?=$row['certificate_medical_result']?></td>
