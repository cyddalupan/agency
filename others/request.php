...
<div class="tab">
<button class="tablinks" style="background:#DC143C;color:white"><a href="request.php" style="color:white"> For Approval Office/Agent </button></a>
...
<button class="tablinks" style="background:blue;color:white"><a href="requestreturn.php" style="color:white"> Return to Maker </button></a>
...
<h1 style="text-align:center;color:#000080;font-size:24px">For Approval Payment Request of AGENT/OFFICE Expense</h1>
...
where request_payment=0 AND amount!=0
...
while($select2222=mysql_fetch_array($listrrrr))
	...
	<div style="width:200px;float:left;color:black;FONT-SIZE:11PX;margin-top:-5px">'.$select2222["l_type"].': '.$select2222["l_currency"].''.$select2222["l_amount"].' </div></p><div style="clear:both"></div>
	';
	}
//}

echo'</td>';
echo'<td> <b style="color:Red">'.$row["currency"].''.$netpay.'</b></td>';
