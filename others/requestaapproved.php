...
<h2 style="font-size:22px;text-align:center">Payment Approved</h2>
...
<button class="tablinks" style="background:#DC143C;color:white"><a href="requestaapproved.php" style="color:white"> Approved</button></a>
