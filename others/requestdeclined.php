...
<h2 style="font-size:22px;text-align:center">Payment Declined</h2>
...
<button class="tablinks" style="background:#DC143C;color:white"><a href="requestdeclined.php" style="color:white"> Decline </button></a>
...
<h1 style="text-align:center;color:#000080;font-size:24px">Declined Request </h1>
