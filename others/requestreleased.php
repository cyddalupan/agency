...
<h2 style="font-size:22px;text-align:center;font-size:24px">Payment Released</h2>
...
<button class="tablinks" style="background:#DC143C;color:white"><a href="requestreleased.php" style="color:white"> Released</button></a>
...
<h1 style="text-align:center;color:#000080;font-size:24px">Released  of AGENT/OFFICE Expense</h1>
