...
// message  me
 ...
 if(isset($_POST["add_agreeme"])){
			...
			$message = "Good day Ms. ".""."".$row['applicant_first']."  ".$row['applicant_last']." ".$_POST["remarksme"]."\n\n".$_POST["staff"];
...
<h1 style="color:black">SMS Manual</h1>
...
<div class="col-md-4 col-sm-9 col-xs-12">
<textarea name="remarksme" rows="1" class="form-control" placeholder=""  required style="width:400px;height:200px"></textarea>
</div>
</div>
