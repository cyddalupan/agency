...
// message  me
 ...
 if(isset($_POST["add_agreeme"])){
			...
			$password = 'adonis13288';
				$message = "Good day Ms. ".""."".$row['applicant_first']."  ".$row['applicant_last']."".",please be informed of your BIOMETRCS schedule dated ".date('M-d-Y', strtotime($_POST['vfs']))." 8:00am.".""."Please be at Sky Lines OFFICE 30 minutes before your schedule."."\n\n".$_POST["staff"];
...
<h1 style="color:black">SMS BIOMETRIC</h1>
...
<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">BIO Schedule </label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="vfs" type="date"  value="<?php echo $row['vfs']; ?>">
</div>
</div>
