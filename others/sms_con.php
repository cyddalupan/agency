...
SET requirement_contract='".$_POST['requirement_contract']."'
...
// message  me
 ...
 if(isset($_POST["add_agreeme"])){
			...
			$password = 'adonis13288';
						$message = "Good day Ms. ".""."".$row['applicant_first']."  ".$row['applicant_last']."".",please be informed that your contract is arrived . Please come to office to SIGN  ".date('M-d-Y', strtotime($_POST['requirement_contract']))." .".""."Sky Lines OFFICE ."."\n\n".$_POST["staff"];
...
<h1 style="color:black">SMS CONTRACT</h1>
...
<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">Contract Received </label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="requirement_contract" type="date"  value="<?php echo $row['requirement_contract']; ?>">
</div>
</div>
