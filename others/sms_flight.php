...
$app4 = mysql_query("UPDATE  applicant_requirement
SET flight_date='".$_POST['flight_date']."'
,ticket_plus='".$_POST['ticket_plus']."'
WHERE requirement_applicant=".$_GET['idme']." ");
...
// message  me
 ...
 if(isset($_POST["add_agreeme"])){
			...
			$message = "Good day Ms. ".""."".$row['applicant_first']."  ".$row['applicant_last']."".",your FLIGHT schedule is on ".date('M-d-Y', strtotime($_POST['flight_date']))."  ".$_POST['ticket_plus'].".".""."Please stay at our accommodation day 
        before the flight."."\n\n".$_POST["staff"];
...
<h1 style="color:black">FLIGHT DETAILS SMS</h1>
...
<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">FLIGHT DETAILS   </label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="flight_date" type="date"   value="<?php echo $row['flight_date']; ?>">
</div>
</div>


<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">FLIGHT TIME   <b style="color:Red"> e.g 22:10</b></label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="ticket_plus" type="TEXT"   value="<?php echo $row['ticket_plus']; ?>">
</div>
</div>
