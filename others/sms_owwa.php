...
SET certificate_owwa_from='".$_POST['owwa']."'
,certificate_owwa_to='".$_POST['owwa1']."'
...
// message  me
 ...
 if(isset($_POST["add_agreeme"])){
			...
			$message = "Good day Ms. ".""."".$row['applicant_first']."  ".$row['applicant_last']."".",please be informed of your OWWA schedule dated ".date('M-d-Y', strtotime($_POST['owwa']))."  To ".date('M-d-Y', strtotime($_POST['owwa1']))." 8:00am.".""."Please be at Sky Lines OFFICE 30 minutes before your schedule."."\n\n".$_POST["staff"];
...
<h1 style="color:black">SMS OWWA</h1>
...
<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">Owwa FROM </label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="owwa" type="date" value="<?php echo $row['certificate_owwa_from']; ?>">
</div>
</div>


<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">Owwa TO </label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="owwa1" type="date" value="<?php echo $row['certificate_owwa_to']; ?>">
</div>
</div>
