...
// message  me
 ...
 if(isset($_POST["add_agreeme"])){
			...
			$message = "Good day Ms. ".""."".$row['applicant_first']."  ".$row['applicant_last']."".", your RT-PCR Test (Swab Test) will be on ".date('M-d-Y', strtotime($_POST['swab_date']))."   8:00am.".""."Please be at Sky Lines OFFICE 30 minutes before your schedule."."\n\n".$_POST["staff"];
...
<h1 style="color:black">SWAB TEST BIOMETRIC</h1>
...
<div class="form-group">
<label class="control-label col-md-3 col-sm-3 col-xs-12">SWAB  Schedule </label>
<div class="col-md-4 col-sm-9 col-xs-12">
<input name="swab_date" type="date"  value="<?php echo $row['swab_date']; ?>">
</div>
</div>
