...
if($_GET['id']==5) { $stat="Interview";}
if($_GET['id']==2) { $stat="Hired";}
...
AND applicant_employer=".$_GET['client']."
...
<a target="_blank"  href="http://fcec-inc.com/system/public/resume/applicant/';?><?=$number?>
