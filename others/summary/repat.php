...
IF($_GET['num']==1){
$title="Today";
$filter="repat_date between date_sub(now(), interval 0 day)  AND date_add(now(), interval 1 day)";

}
IF($_GET['num']==2){
$title="Weekly";
$filter="repat_date between date_sub(now(), interval 7 day)  AND date_add(now(), interval 1 day)";
}
IF($_GET['num']==3){
$title="Monthly";
$filter="repat_date between date_sub(now(), interval 30 day)  AND date_add(now(), interval 1 day)";
}

IF($_GET['num']==4){
$title="Yesterday";
$filter="AND repat_date=".$dateko."";
}
...
<h1 style="text-align:center"><?=$title?> Repat</h1>
