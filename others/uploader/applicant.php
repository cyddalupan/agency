	...
	<div class="container">
		<div class="row">
			...
			<div class="span6" id="form-login">
				...
				<form class="form-horizontal well" action="applicantimport.php" method="post" name="upload_excel" enctype="multipart/form-data">
					<fieldset>
						<legend>Import Applicants</legend>
						<div class="control-group">
							<div class="control-label">
								<label>Import Applicant:</label>
							</div>
							<div class="controls">
