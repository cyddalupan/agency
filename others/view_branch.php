...
$nameArray1 = array();
while($rowemployer1 = mysql_fetch_array($employer1)) {
    // Append to the array
     $nameArray1[] = $rowemployer1['a_employer'];  
}
$employerr1=implode(",",$nameArray1);
...
<li><a  class="active" href="view_branch.php?imy=<?=$_GET['imy']?>">All </a></li>
<li><a   href="passporting1.php?imy=<?=$_GET['imy']?>">Passporting </a></li>
<li><a   href="view_branch_w.php?imy=<?=$_GET['imy']?>">Waitlist </a></li>
<li><a   href="alldhb.php?imy=<?=$_GET['imy']?>">All Household </a></li>
...
echo'<td><button type="button" class="btn btn-'.$row["statusColors"].' btn-xs" style="font-size:12px">'.$row["status"].'</button>-<i style="color:Red">'.$row['applicant_ppt_pay'].'</td>';
