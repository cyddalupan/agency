...
<li><a  class="active" href="view_branch_ro.php?imy=<?=$_GET['imy']?>">All </a></li>
<li><a   href="passporting2.php?imy=<?=$_GET['imy']?>">Passporting </a></li>
<li><a   href="waitlist_ro.php?imy=<?=$_GET['imy']?>">Waitlist </a></li>
