...
<li><a   href="view_coordinator-all.php?user=<?=$_GET['user']?>">All Applicants </a></li>
<li><a href="view_line.php?user=<?=$_GET['user']?>">Line up</a></li>
<li><a  href="view_coordinator1.php?user=<?=$_GET['user']?>">On Process</a></li>
<li><a  href="view_deployed.php?user=<?=$_GET['user']?>">Deployed</a></li>
<li><a   class="active"  href="view_cancelled.php?user=<?=$_GET['user']?>">Cancelled</a></li>
