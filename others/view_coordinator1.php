...
where
requirement_contract NOT  IN ('1970-01-01','0000-00-00','')
...
<h3><span>Under Process Applicants</span></h3>
...
<li><a class="active" href="view_coordinator1.php?user=<?=$_GET['user']?>">On Process</a></li>
...
<a href="view_coordinator1.php?user=<?=$_GET['user']?>">Under Process </a> |  <a href="view_selected.php?user=<?=$_GET['user']?>">Selected</a>
