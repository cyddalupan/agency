...
AND applicant_status  NOT IN (9,21,22,1,14,25)
...
<li><a  class="active" href="view_coordinator11.php?imy=<?=$_GET['imy']?>">In Process </a></li>
<li><a   href="view_coordinator22.php?imy=<?=$_GET['imy']?>">Cancelled </a></li>
</ul>
<h3><span>IN Process Applicants</span></h3>
