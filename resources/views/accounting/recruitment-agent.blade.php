...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6">
        <a href="{{ route('agency.dashboard') }}" class="text-sm text-blue-600 hover:text-blue-800">&larr; Back to Dashboard</a>
    </div>

    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold">{{ $recruitmentAgent->name }}</h1>
            <p class="text-sm text-gray-500">Recruitment Agent Accounting</p>
        </div>
