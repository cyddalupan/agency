...
@section('title', 'Edit User — ' . $agency->name)
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-base-100 rounded-box shadow-sm border p-6">
        <form action="{{ route('agencies.users.update', [$agency, $user]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-control mb-4">
                <label class="label" for="password">
                    ...
                    <span class="label-text-alt opacity-60">Leave blank to keep current</span>
                </label>
