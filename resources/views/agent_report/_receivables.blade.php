{{-- Tab 1c: Receivables — agent-charged expense items on the six receivable accounts (Partial, Full, Fit to work, Contract, Deployed, Return) --}}
<div class="card bg-base-100 shadow-md">
    <div class="card-body">
        <h3 class="font-bold mb-3">📊 Receivables <span class="badge badge-sm badge-ghost">{{ $receivableItems->count() }}</span></h3>
        @if($receivableItems->count())
