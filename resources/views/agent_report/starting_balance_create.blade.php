...
@section('title', 'New Starting Balance')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="card bg-gradient-to-br from-primary via-primary/80 to-secondary text-primary-content shadow-lg mb-6 card-lift">
        <div class="card-body p-6">
            <h1 class="text-2xl font-bold">➕ New Starting Balance</h1>
            <p class="opacity-80 mt-1">Agents Report · Tab 4 — one per agent</p>
        </div>
    </div>
    ...
    <div class="bg-info/10 border border-info/40 text-info-content rounded-lg p-4 mb-5 text-sm">
        ...
        <ul class="list-disc list-inside mt-2 opacity-90">
            ...
            <li><strong>One starting balance per agent</strong> — a second entry for the same agent is rejected.</li>
        </ul>
    </div>

    <form method="POST" action="{{ route('agent_report.starting_balance.store') }}" class="card bg-base-100 shadow-md">
        @csrf
        ...
        <div class="card-body space-y-6">
            <div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" class="input input-bordered w-full" value="{{ $account }}" disabled>
                    </div>
                    <div class="form-control">
            ...
            <div class="flex gap-3 pt-4 border-t border-base-200">
                ...
                <a href="{{ route('agent_report.index', ['tab' => 'starting-balances']) }}" class="btn btn-ghost">Cancel</a>
            </div>
        </div>
    </form>
