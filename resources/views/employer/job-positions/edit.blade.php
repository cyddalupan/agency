...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('employer.job-positions.update', $jobPosition) }}" method="POST" class="card bg-base-100 shadow-sm card-lift">
        <div class="card-body space-y-4">
            ...
            <fieldset class="fieldset">
                ...
                <textarea name="content" rows="4" class="textarea w-full" placeholder="Job description...">{{ old('content', $jobPosition->content) }}</textarea>
            </fieldset>
            ...
            <fieldset class="fieldset">
                ...
                <select name="status" class="select w-full">
                    ...
                    <option value="closed" @selected(old('status', $jobPosition->status) === 'closed')>⏸️ Closed</option>
                </select>
            </fieldset>
