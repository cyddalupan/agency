...
@section('title', 'Statement of Account - ' . $employer->name)
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="card bg-gradient-to-br from-secondary via-secondary/80 to-accent text-secondary-content shadow-lg mb-6 card-lift">
        <div class="card-body p-6">
            <a href="{{ route('employers.show', $employer) }}" class="text-sm opacity-80 hover:opacity-100 flex items-center gap-1 mb-2">
                <span>←</span> Back to {{ $employer->name }}
            </a>
    ...
    <div class="card bg-base-100 shadow-md mb-6">
        <div class="card-body">
            ...
            @if($bills->isEmpty())
                <p class="text-center py-6 opacity-50">No bills found for this employer.</p>
            @else
                        ...
                        <tbody>
                            ...
                            @foreach($bills as $bill)
                                @php
                                    ...
                                    $runningBalance += $bill->employer_cost - $billPayments;
                                @endphp
                                <tr>
