...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 p-4">
    ...
    <div class="w-full max-w-sm bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 relative z-10 animate-fade-in">
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-extrabold text-gray-900">{{ __('messages.forgot_password') }}</h1>
        ...
        <form method="POST" action="{{ route('fra.password.email') }}">
            @csrf
            <div class="mb-4">
        ...
        <p class="text-center mt-4">
            <a href="{{ route('fra.login') }}" class="text-sm text-blue-600 hover:text-blue-800 hover:underline">
                ← Back to Login
            </a>
        </p>
    </div>
