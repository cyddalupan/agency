        ...
        <table class="lc-table">
            ...
            <tbody>
                ...
                <tr class="{{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50' }}">
                    ...
                    <td>
                        @if($applicant->contractRecords->first()?->contract_received)
                    ...
                    <td>
                        @if($applicant->contractRecords->first()?->contract_signed)
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                            {{ __('messages.signed') }}
                        </span>
                        @elseif($applicant->contractRecords->first()?->contract_received)
