...
<div class="max-w-xl mx-auto">
    ...
    <div class="card bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 mb-6 p-4">
        <h2 class="text-2xl font-bold flex items-center gap-2">
            <span>🛠️</span> New Skill
        </h2>
        <p class="opacity-60 text-sm mt-1">Add a new skill</p>
    </div>
    ...
    <form action="{{ route('skills.store') }}" method="POST" class="card bg-base-100 shadow-sm card-lift">
