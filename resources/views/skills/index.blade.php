...
<div class="max-w-3xl mx-auto">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
            ...
            <p class="opacity-60 text-sm mt-1">Manage available skills</p>
        </div>
                        ...
                        <tr class="hover transition-colors">
                            ...
                            <td class="text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('skills.edit', $skill) }}" class="btn btn-ghost btn-xs btn-square" title="Edit">✏️</a>
    ...
    @else
        <div class="card bg-base-100 shadow-sm card-lift">
            <div class="card-body items-center text-center py-16">
                ...
                <h3 class="text-xl font-bold mb-2">No Skills Yet</h3>
                <p class="opacity-60 mb-6 max-w-md">
                    Create skills to categorize your records.
                </p>
                <div class="flex flex-wrap justify-center gap-3">
                    <a href="{{ route('skills.create') }}" class="btn btn-primary btn-lg">
                        <span>➕</span> Create Your First Skill
                    </a>
                </div>
            </div>
        </div>
