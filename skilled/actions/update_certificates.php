...
require_once(dirname(dirname(__DIR__)) . '/src/updaters/ApplicantCertificateUpdater.php');
require_once(dirname(dirname(__DIR__)) . '/src/handlers/CertificatesHandler.php');
...
if ($user_id === null || $user_id !== (int)$_SESSION['user_id']) {
    ...
    header('Location: ' . SITE_URL . 'skilled/certificates.php');
    exit;
}
