...
$page = 'job_preferences'; // For the navigation
...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form action="actions/update_job_preferences.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="applicant_id" value="<?php echo htmlspecialchars($user_data['applicant_id']); ?>">

                <div class="mt-3">
                    <?php
                    // Include the content for the job_preferences page
                    include_once('profile/job_preferences.php');
                    ?>
                </div>
