...
$page = 'work_experience'; // For the navigation
...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form action="actions/update_work_experience.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="applicant_id" value="<?php echo htmlspecialchars($user_data['applicant_id']); ?>">

                <div class="mt-3">
                    <?php
                    // Include the content for the work_experience page
                    include_once('profile/work_experience.php');
                    ?>
                </div>
