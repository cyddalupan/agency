...
require_once(dirname(dirname(__DIR__)) . '/src/handlers/FamilyBackgroundHandler.php');
...
if ($user_id === null || $user_id !== (int)$_SESSION['user_id']) {
    ...
    header('Location: ' . SITE_URL . 'skilled/family_background.php');
    exit;
}
...
try {
    ...
    if ($success) {
        $_SESSION['message'] = 'Family background updated successfully!';
    } else {
...
// Redirect back to the family background page
