...
$page = 'family_background'; // For the navigation
...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form action="actions/update_family_background.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="applicant_id" value="<?php echo htmlspecialchars($user_data['applicant_id']); ?>">

                <div class="mt-3">
                    <?php
                    // Include the content for the family_background page
                    include_once('profile/family_background.php');
                    ?>
                </div>
